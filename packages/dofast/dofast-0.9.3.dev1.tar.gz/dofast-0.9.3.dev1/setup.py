...
setuptools.setup(
    name="dofast",
    version="0.9.3.dev1",  # Latest version .
    author="GaoangLiu",
    ...
    entry_points={
        'console_scripts': [
            ...
            'vps_monitor=dofast.linux.vps:main','pcloud_upload=dofast.web.pcloud:pcloud_upload_entry',
            'calculate_prime=dofast.nsq.calculate_prime:calculate_prime','vvv=dofast.client:entry'
        ]
    },
    classifiers=[
