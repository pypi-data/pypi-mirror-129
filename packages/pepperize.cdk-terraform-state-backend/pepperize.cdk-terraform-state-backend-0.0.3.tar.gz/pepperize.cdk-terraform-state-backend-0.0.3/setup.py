    ...
    """
{
    ...
    "license": "MIT",
    "url": "https://github.com/patrick.florek/papperize/cdk-terraform-state-backend.git",
    ...
    "project_urls": {
        "Source": "https://github.com/patrick.florek/papperize/cdk-terraform-state-backend.git"
    },
    "package_dir": {
        "": "src"
    },
    ...
    "package_data": {
        "pepperize_cdk_terraform_state_backend._jsii": [
            "cdk-terraform-state-backend@0.0.3.jsii.tgz"
        ],
        "pepperize_cdk_terraform_state_backend": [
            "py.typed"
        ]
