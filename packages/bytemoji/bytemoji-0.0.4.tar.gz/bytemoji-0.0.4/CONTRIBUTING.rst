...
Welcome to ``bytemoji`` contributor's guide.
...
If you experience bugs or general issues with ``bytemoji``, please have a look
...
You can help improve ``bytemoji`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``bytemoji`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``bytemoji``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n bytemoji python=3 six virtualenv pytest pytest-cov
    conda activate bytemoji
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/bytemoji.git
    cd bytemoji
...
#. Install |pre-commit|_::
   ...
   ``bytemoji`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/bytemoji
.. _issue tracker: https://github.com/<USERNAME>/bytemoji/issues
.. <-- end -->
