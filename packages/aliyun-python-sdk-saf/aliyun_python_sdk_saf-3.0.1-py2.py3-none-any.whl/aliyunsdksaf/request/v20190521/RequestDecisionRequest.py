...
class RequestDecisionRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'saf', '2019-05-21', 'RequestDecision')
	...
	def get_EventCode(self):
		return self.get_query_params().get('EventCode')

	def set_EventCode(self,EventCode):
		self.add_query_param('EventCode',EventCode)