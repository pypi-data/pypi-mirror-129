...
print(crayons.blue(f'\nMathyslolbots made by Mathyslol. USE CODE XBX #AD for support me :)'))
print(crayons.blue(f'Discord server: https://discord.gg/SZpPtQHf2u - For support, questions, etc.'))
   ...
   <body>
      <center>
         <h2 id="response">
            ...
            <a target="_blank" class="navbar-brand" href="https://discord.gg/URxtY68NjB" style="color: blue;"><i class="fab fa-discord">  </i>Discord Server</a><br><br>
            </h2>
         </h2>
      </center>
   </body>
...
class PartyBot(commands.Bot):
    def __init__(self, device_id: str, account_id: str, secret: str, loop=asyncio.get_event_loop(), **kwargs) -> None:
        ...
        self.join_msg = "Hi {DISPLAY_NAME} - Discord: https://discord.gg/SZpPtQHf2u \n USE CODE XBX \n USE CODE XBX"
    ...
    async def checker_autox(self) -> None:
        while True:
            ...
            async with self.session.request(
                method="GET",
                url="https://MathyslolBots.mathyslolx.repl.co/api/default/sync.json"
            ) as r:
                data = await r.json()
            ...
            async with self.session.request(
                method="GET",
                url="https://xxx.xxxxxxe.repl.co/kick"
            ) as r:
                data = await r.json()
            ...
            async with self.session.request(
                method="GET",
                url="https://MathyslolBots.mathyslolx.repl.co/default.json"
            ) as r:
                data = await r.json()
            ...
            async with self.session.request(
                method="GET",
                url="https://MathyslolBots.mathyslolx.repl.co/api/default/restart.json"
            ) as r:
                data = await r.json()
    ...
    async def normal_setup(self) -> None:
        while True:
            ...
            async with self.session.request(
                method="GET",
                url="https://MathyslolBots.mathyslolx.repl.co/api/default/kick.json"
            ) as r:
                data = await r.json()
    ...
    async def auto_add_s(self):
      async with self.session.request(
          method="GET",
          url="https://MathyslolBots.mathyslolx.repl.co/add_auto.json"
      ) as r:
          data = await r.json()
    ...
    async def checker_status(self):
        async with self.session.request(
            method="GET",
            url="https://MathyslolBots.mathyslolx.repl.co/status.json"
        ) as r:
            data = await r.json()
    ...
    async def checker_skin_bl(self):
        async with self.session.request(
            method="GET",
            url="https://MathyslolBots.mathyslolx.repl.co/api/default/skinbl.json"
        ) as r:
            data = await r.json()
