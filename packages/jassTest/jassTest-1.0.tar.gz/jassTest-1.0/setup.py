...
class CMakeBuild(build_ext):
    ...
    def build_cmake(self, ext):
        try:
            ...
            raise RuntimeError(
                "Swing must be installed to build the following extensions: "
...
setup(
    ...
    packages=[''],
    package_dir={'': '.'},
   package_data={'': ['build/Doxyfile.in']}, #replace me with your package data
   classifiers=[
   ...
   ext_modules=[CMakeExtension("anytime")], # force python to generate a dummy.so/pyc bindings - cmake script takes care of that
