...
class CMakeBuild(build_ext):
    ...
    def build_cmake(self, ext):
        ...
        path = extdir + "/dummy.cpython-" + str(sys.version_info[0]) + str(sys.version_info[1]) + "-darwin.so"
...
#        env = os.environ.copy()
        ...
        if platform.system() == "Darwin":
            fakeLib = extdir + "/dummy.cpython-" + str(sys.version_info[0]) + str(sys.version_info[1]) + "-darwin.so"
