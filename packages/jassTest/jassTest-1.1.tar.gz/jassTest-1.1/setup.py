...
setup(
    ...
    packages=[''],
    package_dir={'': '.'},
   package_data={'': ['']}, #replace me with your package data
   classifiers=[
   ...
   ext_modules=[CMakeExtension("JASS_compiled_index")], # force python to generate a dummy.so/pyc bindings - cmake script takes care of that
