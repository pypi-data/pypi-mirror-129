...
**Find more examples [here](https://github.com/facebookincubator/submitit/blob/1.4.1/docs/examples.md)!!!**
...
You can try running the [MNIST example](https://github.com/facebookincubator/submitit/blob/1.4.1/docs/mnist.py) to check that everything is working as expected (requires sklearn).
...
- [Examples](https://github.com/facebookincubator/submitit/blob/1.4.1/docs/examples.md): for a bunch of examples dealing with errors, concurrency, multi-tasking etc...
- [Structure and main objects](https://github.com/facebookincubator/submitit/blob/1.4.1/docs/structure.md): to get a better understanding of how `submitit` works, which files are created for each job, and the main objects you will interact with.
- [Checkpointing](https://github.com/facebookincubator/submitit/blob/1.4.1/docs/checkpointing.md): to understand how you can configure your job to get checkpointed when preempted and/or timed-out.
- [Tips and caveats](https://github.com/facebookincubator/submitit/blob/1.4.1/docs/tips.md): for a bunch of information that can be handy when working with `submitit`.
- [Hyperparameter search with nevergrad](https://github.com/facebookincubator/submitit/blob/1.4.1/docs/nevergrad.md): basic example of `nevergrad` usage and how it interfaces with `submitit`.
...
By chronological order: Jérémy Rapin, Louis Martin, Lowik Chanussot, Lucas Hosseini, Fabio Petroni, Francisco Massa, Guillaume Wenzek, Thibaut Lavril, Vinayak Tantia, Andrea Vedaldi, Max Nickel, Quentin Duval (feel free to [contribute](https://github.com/facebookincubator/submitit/blob/1.4.1/.github/CONTRIBUTING.md) and add your name ;) )

## License

Submitit is released under the [MIT License](https://github.com/facebookincubator/submitit/blob/1.4.1/LICENSE).
