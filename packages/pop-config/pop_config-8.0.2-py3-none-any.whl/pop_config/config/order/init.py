...
def apply(hub, raw:Dict, raw_cli:Dict, cli:Dict, cli_args:Dict, os_vars:Dict, configs:Dict) -> Dict:
    """
...
def cli_vars(hub, raw_cli: Dict[str, Dict], cli_args:Dict[str, Dict], cli:Dict[str, Dict], ret:Dict) -> Dict:
    """
    Read CLI variables
    """
    for key in cli_args:
