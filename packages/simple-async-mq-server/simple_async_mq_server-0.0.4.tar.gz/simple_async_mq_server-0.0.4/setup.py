...
setup(
  ...
  packages = find_namespace_packages(include=['simple_async_mq_server.*']),#['simple_async_mq_server'],   # Chose the same as "name"
  ...
  download_url = 'https://github.com/3520kramer/simple-async-mq-server/archive/v_004.tar.gz',    # I explain this later on
