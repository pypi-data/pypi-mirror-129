...
setup(
  ...
  packages = ['simple_async_mq_server'],   # Chose the same as "name"
  ...
  download_url = 'https://github.com/3520kramer/simple-async-mq-server/archive/v_001.tar.gz',    # I explain this later on
