...
setup(
  ...
  packages = find_namespace_packages(include=['simple_async_mq_server.*']),
  ...
  download_url = 'https://github.com/3520kramer/simple-async-mq-server/archive/v_007.tar.gz',    # I explain this later on
