...
class ListBox(Component):
    ...
    delete_identity = Aspect(docstring="Delete row item by component identity.")  # noqa: E501
    ...
    def __init__(
            ...
            delete_identity: typing.Optional[str] = UNDEFINED,
        ...
        :param delete_identity: Delete row item by component identity.
