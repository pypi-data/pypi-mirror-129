...
class Grid(Component):
    ...
    center_cells = Aspect(docstring="Center the content of the cells.")
    ...
    def __init__(
            ...
            center_cells: typing.Optional[bool] = UNDEFINED,
        ...
        :param equal_cell_width: Each cell are equals in width for a total
            of 100% per row.
        :param center_cells: Center the content of the cells.
