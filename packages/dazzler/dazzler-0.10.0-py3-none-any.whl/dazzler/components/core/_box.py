...
class Box(Component):
    ...
    clicks = Aspect(default=0, docstring="Number of times the box was clicked on. (default=0)")  # noqa: E501
    ...
    def __init__(
        ...
        :param clicks: Number of times the box was clicked on. (default=0)
