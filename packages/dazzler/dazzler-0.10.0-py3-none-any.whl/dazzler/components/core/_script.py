...
class Script(Component):
    ...
    """
    uri = Aspect(required=True, docstring="The script to load.")
    loaded = Aspect()
    timeout = Aspect(default=30000, docstring="(default=30000)")
    error = Aspect()
    ...
    def __init__(
            ...
            timeout: typing.Optional[typing.Union[float, int]] = 30000,
