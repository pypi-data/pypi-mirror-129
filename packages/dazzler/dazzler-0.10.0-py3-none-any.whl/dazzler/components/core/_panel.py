...
class Panel(Component):
    ...
    title_color = Aspect(docstring="Preset color to use as font color for the title. (Possible values: 'primary', 'primary-light', 'primary-dark', 'secondary', 'secondary-light', 'secondary-dark', 'tertiary', 'tertiary-light', 'tertiary-dark', 'danger', 'danger-light', 'danger-dark', 'warning', 'warning-light', 'warning-dark', 'success', 'success-light', 'success-dark', 'neutral', 'neutral-light', 'neutral-dark', 'dark', 'dark-light', 'dark-dark', 'darker', 'darker-light', 'darker-dark')")  # noqa: E501
    title_background = Aspect(docstring="Color preset for the background of the title. (Possible values: 'primary', 'primary-light', 'primary-dark', 'secondary', 'secondary-light', 'secondary-dark', 'tertiary', 'tertiary-light', 'tertiary-dark', 'danger', 'danger-light', 'danger-dark', 'warning', 'warning-light', 'warning-dark', 'success', 'success-light', 'success-dark', 'neutral', 'neutral-light', 'neutral-dark', 'dark', 'dark-light', 'dark-dark', 'darker', 'darker-light', 'darker-dark')")  # noqa: E501
    ...
    def __init__(
            ...
            title_color: typing.Optional[typing.Any] = UNDEFINED,
            title_background: typing.Optional[typing.Any] = UNDEFINED,
        ...
        :param title_class_name: Class name to give to the title along with
            ``panel-title``.
        :param title_color: Preset color to use as font color for the
            title. (Possible values: 'primary', 'primary-light', 'primary-
            dark', 'secondary', 'secondary-light', 'secondary-dark',
            'tertiary', 'tertiary-light', 'tertiary-dark', 'danger', 'danger-
            light', 'danger-dark', 'warning', 'warning-light', 'warning-dark',
        ...
        :param title_background: Color preset for the background of the
            title. (Possible values: 'primary', 'primary-light', 'primary-
            dark', 'secondary', 'secondary-light', 'secondary-dark',
            'tertiary', 'tertiary-light', 'tertiary-dark', 'danger', 'danger-
            light', 'danger-dark', 'warning', 'warning-light', 'warning-dark',
