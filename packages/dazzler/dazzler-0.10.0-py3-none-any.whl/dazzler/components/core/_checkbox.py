...
class Checkbox(Component):
    ...
    """
    checked = Aspect(default=False, docstring="Whether the checkbox is toggled or not. (default=False)")  # noqa: E501
    indeterminate = Aspect(docstring="Indeterminate display `-` meaning partial selection.")  # noqa: E501
    disabled = Aspect(docstring="Disable the checkbox")
    click_indeterminate = Aspect(docstring="Click on the checkbox will also set indeterminate status.")  # noqa: E501
    ...
    def __init__(
            ...
            click_indeterminate: typing.Optional[bool] = UNDEFINED,
        ...
        """
        :param checked: Whether the checkbox is toggled or not.
            (default=False)
        :param indeterminate: Indeterminate display `-` meaning partial
            selection.
        :param disabled: Disable the checkbox
        :param click_indeterminate: Click on the checkbox will also set
