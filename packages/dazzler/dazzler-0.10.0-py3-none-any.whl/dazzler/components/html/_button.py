...
class Button(Component):
    ...
    type = Aspect(docstring="(Possible values: 'button', 'submit', 'reset')")
    accessKey = Aspect()
    ...
    def __init__(
            ...
            form: typing.Optional[str] = UNDEFINED,
            autoFocus: typing.Optional[bool] = UNDEFINED,
            disabled: typing.Optional[bool] = UNDEFINED,
            formAction: typing.Optional[str] = UNDEFINED,
            formEncType: typing.Optional[str] = UNDEFINED,
            formMethod: typing.Optional[str] = UNDEFINED,
            formNoValidate: typing.Optional[bool] = UNDEFINED,
            formTarget: typing.Optional[str] = UNDEFINED,
        ...
        """
        :param children:
        :param type: (Possible values: 'button', 'submit', 'reset')
        :param accessKey:
