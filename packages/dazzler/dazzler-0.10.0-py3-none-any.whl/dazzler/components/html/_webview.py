...
class Webview(Component):
    ...
    allowpopups = Aspect()
    autosize = Aspect()
    blinkfeatures = Aspect()
    disableblinkfeatures = Aspect()
    disableguestresize = Aspect()
    disablewebsecurity = Aspect()
    guestinstance = Aspect()
    httpreferrer = Aspect()
    nodeintegration = Aspect()
    partition = Aspect()
    plugins = Aspect()
    useragent = Aspect()
    webpreferences = Aspect()
    ...
    def __init__(
            ...
            preload: typing.Optional[str] = UNDEFINED,
            src: typing.Optional[str] = UNDEFINED,
            autoFocus: typing.Optional[bool] = UNDEFINED,
            allowFullScreen: typing.Optional[bool] = UNDEFINED,
            allowpopups: typing.Optional[bool] = UNDEFINED,
            autosize: typing.Optional[bool] = UNDEFINED,
            blinkfeatures: typing.Optional[str] = UNDEFINED,
            disableblinkfeatures: typing.Optional[str] = UNDEFINED,
            disableguestresize: typing.Optional[bool] = UNDEFINED,
            disablewebsecurity: typing.Optional[bool] = UNDEFINED,
            guestinstance: typing.Optional[str] = UNDEFINED,
            httpreferrer: typing.Optional[str] = UNDEFINED,
            nodeintegration: typing.Optional[bool] = UNDEFINED,
            partition: typing.Optional[str] = UNDEFINED,
            plugins: typing.Optional[bool] = UNDEFINED,
            useragent: typing.Optional[str] = UNDEFINED,
            webpreferences: typing.Optional[str] = UNDEFINED,
        ...
        :param autosize:
        :param blinkfeatures:
        :param disableblinkfeatures:
        :param disableguestresize:
        :param disablewebsecurity:
        :param guestinstance:
        :param httpreferrer:
        :param nodeintegration:
        :param partition:
        :param plugins:
        :param useragent:
