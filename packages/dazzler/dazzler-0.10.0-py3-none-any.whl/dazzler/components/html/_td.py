...
class Td(Component):
    ...
    height = Aspect()
    width = Aspect()
    align = Aspect(docstring="(Possible values: 'left', 'center', 'right', 'justify', 'char')")  # noqa: E501
    colSpan = Aspect()
    headers = Aspect()
    rowSpan = Aspect()
    scope = Aspect()
    abbr = Aspect()
    valign = Aspect(docstring="(Possible values: 'top', 'middle', 'bottom', 'baseline')")  # noqa: E501
    ...
    def __init__(
            ...
            colSpan: typing.Optional[typing.Union[float, int]] = UNDEFINED,
            headers: typing.Optional[str] = UNDEFINED,
            rowSpan: typing.Optional[typing.Union[float, int]] = UNDEFINED,
            scope: typing.Optional[str] = UNDEFINED,
            abbr: typing.Optional[str] = UNDEFINED,
            valign: typing.Optional[typing.Any] = UNDEFINED,
        ...
        :param height:
        :param width:
        :param align: (Possible values: 'left', 'center', 'right',
            'justify', 'char')
        :param colSpan:
        :param headers:
        :param rowSpan:
        :param scope:
        :param abbr:
        :param valign: (Possible values: 'top', 'middle', 'bottom',
            'baseline')
        :param handle_clicks:
        :param clicks:
        :param click_event:
