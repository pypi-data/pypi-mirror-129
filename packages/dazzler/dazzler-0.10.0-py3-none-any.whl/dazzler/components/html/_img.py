...
class Img(Component):
    ...
    decoding = Aspect(docstring="(Possible values: 'async', 'auto', 'sync')")
    sizes = Aspect()
    srcSet = Aspect()
    useMap = Aspect()
    ...
    def __init__(
            ...
            sizes: typing.Optional[str] = UNDEFINED,
            srcSet: typing.Optional[str] = UNDEFINED,
            useMap: typing.Optional[str] = UNDEFINED,
        ...
        :param decoding: (Possible values: 'async', 'auto', 'sync')
        :param sizes:
        :param srcSet:
        :param useMap:
        :param handle_clicks:
