...
class Textarea(Component):
    ...
    def __init__(
            ...
            autoComplete: typing.Optional[str] = UNDEFINED,
            required: typing.Optional[bool] = UNDEFINED,
            cols: typing.Optional[typing.Union[float, int]] = UNDEFINED,
            dirName: typing.Optional[str] = UNDEFINED,
            maxLength: typing.Optional[typing.Union[float, int]] = UNDEFINED,
            minLength: typing.Optional[typing.Union[float, int]] = UNDEFINED,
            readOnly: typing.Optional[bool] = UNDEFINED,
            rows: typing.Optional[typing.Union[float, int]] = UNDEFINED,
            wrap: typing.Optional[str] = UNDEFINED,
