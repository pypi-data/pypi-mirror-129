...
class Iframe(Component):
    ...
    width = Aspect()
    allow = Aspect()
    allowFullScreen = Aspect()
    allowTransparency = Aspect()
    frameBorder = Aspect(docstring="@,deprecated")
    loading = Aspect(docstring="(Possible values: 'eager', 'lazy')")
    marginHeight = Aspect(docstring="@,deprecated")
    marginWidth = Aspect(docstring="@,deprecated")
    sandbox = Aspect()
    scrolling = Aspect(docstring="@,deprecated")
    seamless = Aspect()
    srcDoc = Aspect()
    ...
    def __init__(
            ...
            src: typing.Optional[str] = UNDEFINED,
            ...
            allow: typing.Optional[str] = UNDEFINED,
            allowFullScreen: typing.Optional[bool] = UNDEFINED,
            allowTransparency: typing.Optional[bool] = UNDEFINED,
            frameBorder: typing.Optional[typing.Union[str, typing.Union[float, int]]] = UNDEFINED,  # noqa: E501
            loading: typing.Optional[typing.Any] = UNDEFINED,
            marginHeight: typing.Optional[typing.Union[float, int]] = UNDEFINED,  # noqa: E501
            marginWidth: typing.Optional[typing.Union[float, int]] = UNDEFINED,  # noqa: E501
            sandbox: typing.Optional[str] = UNDEFINED,
            scrolling: typing.Optional[str] = UNDEFINED,
            seamless: typing.Optional[bool] = UNDEFINED,
            srcDoc: typing.Optional[str] = UNDEFINED,
        ...
        :param frameBorder: @,deprecated
        :param loading: (Possible values: 'eager', 'lazy')
        :param marginHeight: @,deprecated
        :param marginWidth: @,deprecated
        :param sandbox:
        :param scrolling: @,deprecated
        :param seamless:
        :param srcDoc:
        :param handle_clicks:
        :param clicks:
