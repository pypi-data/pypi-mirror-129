...
class PolarAngleAxis(Component):
    ...
    order = Aspect()
    orient = Aspect()
    orientation = Aspect(docstring="(Possible values: 'inner', 'outer')")
    origin = Aspect()
    overflow = Aspect()
    ...
    AxisComp = Aspect()
    angleAxisId = Aspect()
    axisLineType = Aspect(docstring="(Possible values: 'circle', 'polygon')")
    ...
    def __init__(
            ...
            cx: typing.Optional[typing.Union[float, int]] = UNDEFINED,
            cy: typing.Optional[typing.Union[float, int]] = UNDEFINED,
            ...
            radius: typing.Optional[typing.Union[float, int]] = UNDEFINED,
            ...
            ticks: typing.Optional[typing.List[typing.Dict[str, typing.Union[typing.Any, typing.Union[float, int]]]]] = UNDEFINED,  # noqa: E501
            ...
            axisLineType: typing.Optional[typing.Any] = UNDEFINED,
            identity: str = None
    ):
        """
        :param string:
        ...
        :param order:
        :param orient:
        :param orientation: (Possible values: 'inner', 'outer')
        :param origin:
        :param overflow:
        ...
        :param AxisComp:
        :param angleAxisId:
        :param axisLineType: (Possible values: 'circle', 'polygon')
        """
