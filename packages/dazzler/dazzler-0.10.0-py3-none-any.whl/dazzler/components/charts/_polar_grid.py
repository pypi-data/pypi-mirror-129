...
class PolarGrid(Component):
    ...
    polarAngles = Aspect()
    polarRadius = Aspect()
    gridType = Aspect(docstring="(Possible values: 'circle', 'polygon')")
    radialLines = Aspect(required=True)
    ...
    def __init__(
            ...
            innerRadius: typing.Optional[typing.Union[float, int]] = UNDEFINED,  # noqa: E501
            outerRadius: typing.Optional[typing.Union[float, int]] = UNDEFINED,  # noqa: E501
            polarAngles: typing.Optional[typing.List[typing.Union[float, int]]] = UNDEFINED,  # noqa: E501
            polarRadius: typing.Optional[typing.List[typing.Union[float, int]]] = UNDEFINED,  # noqa: E501
            gridType: typing.Optional[typing.Any] = UNDEFINED,
            identity: str = None
    ):
        """
        :param string:
        ...
        :param polarAngles:
        :param polarRadius:
        :param gridType: (Possible values: 'circle', 'polygon')
        :param radialLines:
        """
