...
class RadarChart(Component):
    ...
    hovered = Aspect()
    hover_event = Aspect()
    radars = Aspect(children=True, docstring="List of charts.Radar")
    inner_radius = Aspect()
    outer_radius = Aspect()
    cx = Aspect()
    cy = Aspect()
    ...
    def __init__(
            ...
            radars: typing.Optional[typing.List[typing.Union[str, int, float, Component, typing.List[typing.Union[str, int, float, Component]]]]] = UNDEFINED,  # noqa: E501
        ...
        :param hovered:
        :param hover_event:
        :param radars: List of charts.Radar
        :param inner_radius:
        :param outer_radius:
        :param cx:
        :param cy:
