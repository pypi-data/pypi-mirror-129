...
class Brush(Component):
    ...
    padding = Aspect()
    data = Aspect()
    travellerWidth = Aspect()
    traveller = Aspect()
    gap = Aspect()
    startIndex = Aspect()
    endIndex = Aspect()
    leaveTimeOut = Aspect()
    alwaysShowText = Aspect()
    updateId = Aspect()
    ...
    def __init__(
            ...
            children: typing.Optional[typing.Any] = UNDEFINED,
            ...
            travellerWidth: typing.Optional[typing.Union[float, int]] = UNDEFINED,  # noqa: E501
            traveller: typing.Optional[typing.Any] = UNDEFINED,
            gap: typing.Optional[typing.Union[float, int]] = UNDEFINED,
            startIndex: typing.Optional[typing.Union[float, int]] = UNDEFINED,
            endIndex: typing.Optional[typing.Union[float, int]] = UNDEFINED,
            leaveTimeOut: typing.Optional[typing.Union[float, int]] = UNDEFINED,  # noqa: E501
            alwaysShowText: typing.Optional[bool] = UNDEFINED,
            updateId: typing.Optional[typing.Union[str, typing.Union[float, int]]] = UNDEFINED,  # noqa: E501
