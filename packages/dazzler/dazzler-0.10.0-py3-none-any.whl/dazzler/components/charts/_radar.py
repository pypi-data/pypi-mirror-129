...
class Radar(Component):
    ...
    def __init__(
            ...
            baseLinePoints: typing.Optional[typing.List[typing.Dict[str, typing.Union[typing.Union[float, int], typing.Any, str]]]] = UNDEFINED,  # noqa: E501
            identity: str = None
    ):
        """
        :param string:
