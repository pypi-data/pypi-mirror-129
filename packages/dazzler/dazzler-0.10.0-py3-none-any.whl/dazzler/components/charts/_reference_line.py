...
class ReferenceLine(Component):
    ...
    yAxis = Aspect()
    shape = Aspect()
    position = Aspect(docstring="(Possible values: 'end', 'middle', 'start')")
    isFront = Aspect()
    alwaysShow = Aspect()
    ...
    def __init__(
            ...
            position: typing.Optional[typing.Any] = UNDEFINED,
            ...
            segment: typing.Optional[typing.List[typing.Dict[str, typing.Union[typing.Union[str, typing.Union[float, int]]]]]] = UNDEFINED,  # noqa: E501
        ...
        :param yAxis:
        :param shape:
        :param position: (Possible values: 'end', 'middle', 'start')
        :param isFront:
        :param alwaysShow:
