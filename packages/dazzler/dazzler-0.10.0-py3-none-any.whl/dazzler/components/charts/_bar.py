...
class Bar(Component):
    ...
    dataKey = Aspect(required=True)
    unit = Aspect()
    xAxisId = Aspect()
    yAxisId = Aspect()
    stackId = Aspect()
    legendType = Aspect(docstring="(Possible values: 'none', 'square', 'plainline', 'line', 'rect', 'circle', 'cross', 'diamond', 'star', 'triangle', 'wye')")  # noqa: E501
    tooltipType = Aspect()
    label = Aspect()
    layout = Aspect(docstring="(Possible values: 'horizontal', 'vertical')")
    hide = Aspect()
    isAnimationActive = Aspect()
    animationBegin = Aspect()
    ...
    top = Aspect()
    left = Aspect()
    data = Aspect(children=True)
    barSize = Aspect()
    minPointSize = Aspect()
    maxBarSize = Aspect()
    background = Aspect()
    label_lists = Aspect(children=True, docstring="Add charts.LabelList")
    cells = Aspect(children=True, docstring="Add charts.Cell")
    error_bars = Aspect(children=True, docstring="Add charts.ErrorBar")
    ...
    def __init__(
            self,
            dataKey: typing.Union[str, typing.Union[float, int]],
            ...
            radius: typing.Optional[typing.Union[typing.Union[float, int]]] = UNDEFINED,  # noqa: E501
            ...
            xAxisId: typing.Optional[typing.Union[str, typing.Union[float, int]]] = UNDEFINED,  # noqa: E501
            yAxisId: typing.Optional[typing.Union[str, typing.Union[float, int]]] = UNDEFINED,  # noqa: E501
            stackId: typing.Optional[typing.Union[str, typing.Union[float, int]]] = UNDEFINED,  # noqa: E501
            legendType: typing.Optional[typing.Any] = UNDEFINED,
            tooltipType: typing.Optional[typing.Dict[str, typing.Union[typing.Any, typing.List, typing.Union[float, int]]]] = UNDEFINED,  # noqa: E501
            label: typing.Optional[typing.Union[str, typing.Union[float, int]]] = UNDEFINED,  # noqa: E501
            layout: typing.Optional[typing.Any] = UNDEFINED,
            hide: typing.Optional[bool] = UNDEFINED,
            isAnimationActive: typing.Optional[bool] = UNDEFINED,
            animationBegin: typing.Optional[typing.Union[float, int]] = UNDEFINED,  # noqa: E501
            ...
            animationId: typing.Optional[typing.Union[float, int]] = UNDEFINED,  # noqa: E501
            xAxis: typing.Optional[typing.Any] = UNDEFINED,
            yAxis: typing.Optional[typing.Any] = UNDEFINED,
            top: typing.Optional[typing.Union[float, int]] = UNDEFINED,
            left: typing.Optional[typing.Union[float, int]] = UNDEFINED,
            data: typing.Optional[typing.List[typing.Dict[str, typing.Union[typing.Union[float, int], typing.Dict[str, typing.Union[typing.Union[float, int]]], typing.Union[str, typing.Union[float, int]], str, typing.Dict[str, typing.Union[typing.Any, typing.Union[str, typing.Union[float, int]]]], typing.Any, typing.Union[str, int, float, Component, typing.List[typing.Union[str, int, float, Component]]], typing.Dict[str, typing.Union[str]], typing.Union[str], typing.Union[typing.Union[float, int]], bool]]]] = UNDEFINED,  # noqa: E501
            barSize: typing.Optional[typing.Union[float, int]] = UNDEFINED,
            minPointSize: typing.Optional[typing.Union[float, int]] = UNDEFINED,  # noqa: E501
            maxBarSize: typing.Optional[typing.Union[float, int]] = UNDEFINED,
            background: typing.Optional[typing.Any] = UNDEFINED,
            label_lists: typing.Optional[typing.List[typing.Union[str, int, float, Component, typing.List[typing.Union[str, int, float, Component]]]]] = UNDEFINED,  # noqa: E501
            cells: typing.Optional[typing.List[typing.Union[str, int, float, Component, typing.List[typing.Union[str, int, float, Component]]]]] = UNDEFINED,  # noqa: E501
            error_bars: typing.Optional[typing.List[typing.Union[str, int, float, Component, typing.List[typing.Union[str, int, float, Component]]]]] = UNDEFINED,  # noqa: E501
        ...
        :param yAxisId:
        :param stackId:
        :param legendType: (Possible values: 'none', 'square', 'plainline',
            'line', 'rect', 'circle', 'cross', 'diamond', 'star', 'triangle',
            'wye')
        :param tooltipType:
        :param label:
        :param layout: (Possible values: 'horizontal', 'vertical')
        :param hide:
        ...
        :param maxBarSize:
        :param background:
        :param label_lists: Add charts.LabelList
        :param cells: Add charts.Cell
        :param error_bars: Add charts.ErrorBar
