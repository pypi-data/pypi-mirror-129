...
class Funnel(Component):
    ...
    upperWidth = Aspect()
    lowerWidth = Aspect()
    isUpdateAnimationActive = Aspect()
    nameKey = Aspect()
    activeShape = Aspect()
    activeIndex = Aspect()
    lastShapeType = Aspect(docstring="(Possible values: 'triangle', 'rectangle')")  # noqa: E501
    trapezoids = Aspect(children=True)
    ...
    def __init__(
            ...
            upperWidth: typing.Optional[typing.Union[float, int]] = UNDEFINED,
            lowerWidth: typing.Optional[typing.Union[float, int]] = UNDEFINED,
            isUpdateAnimationActive: typing.Optional[bool] = UNDEFINED,
        ...
        :param upperWidth:
        :param lowerWidth:
        :param isUpdateAnimationActive:
        :param nameKey:
        :param activeShape:
        :param activeIndex:
        :param lastShapeType: (Possible values: 'triangle', 'rectangle')
        :param trapezoids:
