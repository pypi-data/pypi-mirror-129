...
class XAxis(Component):
    ...
    order = Aspect()
    orient = Aspect()
    orientation = Aspect(docstring="(Possible values: 'top', 'bottom')")
    origin = Aspect()
    overflow = Aspect()
    ...
    tickLine = Aspect()
    tickSize = Aspect()
    allowDataOverflow = Aspect()
    allowDuplicatedCategory = Aspect()
    allowDecimals = Aspect()
    domain = Aspect()
    axisType = Aspect(docstring="(Possible values: 'xAxis', 'yAxis', 'angleAxis', 'radiusAxis')")  # noqa: E501
    range = Aspect()
    AxisComp = Aspect()
    ...
    def __init__(
            ...
            label: typing.Optional[typing.Union[str, typing.Union[float, int], typing.Dict]] = UNDEFINED,  # noqa: E501
            hide: typing.Optional[bool] = UNDEFINED,
            mirror: typing.Optional[bool] = UNDEFINED,
            ticks: typing.Optional[typing.List[typing.Union[str, typing.Union[float, int]]]] = UNDEFINED,  # noqa: E501
            padding: typing.Optional[typing.Any] = UNDEFINED,
            minTickGap: typing.Optional[typing.Union[float, int]] = UNDEFINED,
            interval: typing.Optional[typing.Union[typing.Union[float, int]]] = UNDEFINED,  # noqa: E501
            reversed: typing.Optional[bool] = UNDEFINED,
            angle: typing.Optional[typing.Union[float, int]] = UNDEFINED,
            tickMargin: typing.Optional[typing.Union[float, int]] = UNDEFINED,
            tick: typing.Optional[typing.Any] = UNDEFINED,
            tickCount: typing.Optional[typing.Union[float, int]] = UNDEFINED,
            axisLine: typing.Optional[typing.Any] = UNDEFINED,
            tickLine: typing.Optional[typing.Any] = UNDEFINED,
            tickSize: typing.Optional[typing.Union[float, int]] = UNDEFINED,
            allowDataOverflow: typing.Optional[bool] = UNDEFINED,
            allowDuplicatedCategory: typing.Optional[bool] = UNDEFINED,
            allowDecimals: typing.Optional[bool] = UNDEFINED,
            domain: typing.Optional[typing.Union[typing.List[str], typing.List[typing.Union[float, int]]]] = UNDEFINED,  # noqa: E501
            axisType: typing.Optional[typing.Any] = UNDEFINED,
            range: typing.Optional[typing.List[typing.Union[float, int]]] = UNDEFINED,  # noqa: E501
            AxisComp: typing.Optional[typing.Any] = UNDEFINED,
        ...
        :param order:
        :param orient:
        :param orientation: (Possible values: 'top', 'bottom')
        :param origin:
        :param overflow:
        ...
        :param tickLine:
        :param tickSize:
        :param allowDataOverflow:
        :param allowDuplicatedCategory:
        :param allowDecimals:
        :param domain:
        :param axisType: (Possible values: 'xAxis', 'yAxis', 'angleAxis',
            'radiusAxis')
        :param range:
        :param AxisComp:
