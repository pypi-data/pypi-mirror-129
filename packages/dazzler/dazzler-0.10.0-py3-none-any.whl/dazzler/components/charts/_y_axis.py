...
class YAxis(Component):
    ...
    order = Aspect()
    orient = Aspect()
    orientation = Aspect(docstring="(Possible values: 'left', 'right')")
    origin = Aspect()
    overflow = Aspect()
    ...
    def __init__(
            ...
            padding: typing.Optional[typing.Dict[str, typing.Union[typing.Union[float, int]]]] = UNDEFINED,  # noqa: E501
        ...
        :param order:
        :param orient:
        :param orientation: (Possible values: 'left', 'right')
        :param origin:
        :param overflow:
