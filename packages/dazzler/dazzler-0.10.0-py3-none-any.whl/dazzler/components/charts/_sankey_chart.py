...
class SankeyChart(Component):
    ...
    nodeWidth = Aspect()
    linkWidth = Aspect()
    linkCurvature = Aspect()
    iterations = Aspect()
    node = Aspect(children=True)
    link = Aspect(children=True)
    sourceX = Aspect()
    sourceY = Aspect()
    sourceControlX = Aspect()
    targetControlX = Aspect()
    data = Aspect()
    ...
    def __init__(
            ...
            targetX: typing.Optional[typing.Union[float, int]] = UNDEFINED,
            targetY: typing.Optional[typing.Union[float, int]] = UNDEFINED,
            ...
            dataKey: typing.Optional[str] = UNDEFINED,
            nameKey: typing.Optional[str] = UNDEFINED,
            nodePadding: typing.Optional[typing.Union[float, int]] = UNDEFINED,  # noqa: E501
            nodeWidth: typing.Optional[typing.Union[float, int]] = UNDEFINED,
            linkWidth: typing.Optional[typing.Union[float, int]] = UNDEFINED,
            linkCurvature: typing.Optional[typing.Union[float, int]] = UNDEFINED,  # noqa: E501
            iterations: typing.Optional[typing.Union[float, int]] = UNDEFINED,
            node: typing.Optional[typing.Union[typing.Dict, typing.Union[str, int, float, Component, typing.List[typing.Union[str, int, float, Component]]]]] = UNDEFINED,  # noqa: E501
            link: typing.Optional[typing.Union[typing.Dict, typing.Union[str, int, float, Component, typing.List[typing.Union[str, int, float, Component]]]]] = UNDEFINED,  # noqa: E501
            sourceX: typing.Optional[typing.Union[float, int]] = UNDEFINED,
            sourceY: typing.Optional[typing.Union[float, int]] = UNDEFINED,
            sourceControlX: typing.Optional[typing.Union[float, int]] = UNDEFINED,  # noqa: E501
            targetControlX: typing.Optional[typing.Union[float, int]] = UNDEFINED,  # noqa: E501
        ...
        :param sourceX:
        :param sourceY:
        :param sourceControlX:
        :param targetControlX:
        :param data:
