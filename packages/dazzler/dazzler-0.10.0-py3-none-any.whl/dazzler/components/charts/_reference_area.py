...
class ReferenceArea(Component):
    ...
    isFront = Aspect()
    alwaysShow = Aspect()
    ifOverflow = Aspect(docstring="(Possible values: 'hidden', 'visible', 'discard', 'extendDomain')")  # noqa: E501
    clipPathId = Aspect()
    ...
    def __init__(
            ...
            viewBox: typing.Optional[typing.Union[str]] = UNDEFINED,
            ...
            isFront: typing.Optional[bool] = UNDEFINED,
            alwaysShow: typing.Optional[bool] = UNDEFINED,
            ifOverflow: typing.Optional[typing.Any] = UNDEFINED,
            clipPathId: typing.Optional[typing.Union[str, typing.Union[float, int]]] = UNDEFINED,  # noqa: E501
        ...
        :param isFront:
        :param alwaysShow:
        :param ifOverflow: (Possible values: 'hidden', 'visible',
            'discard', 'extendDomain')
        :param clipPathId:
