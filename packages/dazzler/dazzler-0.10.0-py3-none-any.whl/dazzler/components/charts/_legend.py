...
class Legend(Component):
    ...
    layout = Aspect(docstring="(Possible values: 'horizontal', 'vertical', 'centric', 'radial')")  # noqa: E501
    margin = Aspect()
    content = Aspect()
    chartWidth = Aspect()
    chartHeight = Aspect()
    ...
    iconSize = Aspect()
    iconType = Aspect()
    align = Aspect(docstring="(Possible values: 'left', 'right', 'center')")
    verticalAlign = Aspect(docstring="(Possible values: 'top', 'middle', 'bottom')")  # noqa: E501
    inactiveColor = Aspect()
    wrapperStyle = Aspect()
    ...
    def __init__(
            ...
            chartWidth: typing.Optional[typing.Union[float, int]] = UNDEFINED,
            chartHeight: typing.Optional[typing.Union[float, int]] = UNDEFINED,  # noqa: E501
            formatter: typing.Optional[typing.Any] = UNDEFINED,
            iconSize: typing.Optional[typing.Union[float, int]] = UNDEFINED,
            iconType: typing.Optional[typing.Dict[str, typing.Union[typing.Any, typing.List, typing.Union[float, int]]]] = UNDEFINED,  # noqa: E501
            align: typing.Optional[typing.Any] = UNDEFINED,
            verticalAlign: typing.Optional[typing.Any] = UNDEFINED,
            inactiveColor: typing.Optional[str] = UNDEFINED,
        ...
        :param iconSize:
        :param iconType:
        :param align: (Possible values: 'left', 'right', 'center')
        :param verticalAlign: (Possible values: 'top', 'middle', 'bottom')
        :param inactiveColor:
        :param wrapperStyle:
