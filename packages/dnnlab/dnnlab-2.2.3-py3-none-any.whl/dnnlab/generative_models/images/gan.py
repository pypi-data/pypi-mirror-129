...
Non-Saturating Game (Practise, NS-GAN)
------------------------------
Each player has its own independently parameterised loss function to eliminate
    ...
    def compile(self,
        ...
        Args:
            ...
            lr_disc: Float. Learning rate used by the discriminator.
                Defaults to 4e4.
            loss: String. Choose between vanilla, hinge and wgan version.
            loss_scaling: Boolean. Used with mixed precision.
        """
        valid = {"vanilla", "hinge", "wgan"}
    ...
    def train_step(self, target_images, batch_size, step, file_writer):
        ...
        with file_writer.as_default():
            ...
            with tf.GradientTape() as gen_tape, tf.GradientTape() as disc_tape:
                ...
                gen_loss = self.generator_loss(self.loss, disc_generated)
                tf.summary.scalar("generator_{}".format(self.loss),
                                  gen_loss,
                                  step=step)

                disc_loss = self.discriminator_loss(self.loss, disc_target,
                                                    disc_generated)
                tf.summary.scalar("discriminator_{}".format(self.loss),
                                  disc_loss,
                                  step=step)
