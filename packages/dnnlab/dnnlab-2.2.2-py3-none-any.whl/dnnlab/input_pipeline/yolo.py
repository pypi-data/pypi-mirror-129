...
def create_dataset(tfrecords,
    ...
    raw_dataset = tf.data.TFRecordDataset(
        tfrecords, compression_type, buffer_size=None, num_parallel_reads=num_parallel_reads)
...
def _parse_tfrecords(example, height, width, depth, key, grid_h, grid_w,
                     anchors, labels):
    ...
    img = tf.io.decode_jpeg(img, channels=depth)
