...
class IdMappingCollection:
    ...
    def idmap_opvl_water(self) -> IdMappingDataframe:
        ...
        file_path = self.get_idmap_file_path(idmap=IdMapChoices.idmap_opvl_water)
        self._id_opvl_water = self.get_idmap_df(idmap=IdMapChoices.idmap_opvl_water, file_path=file_path)
        return self._id_opvl_water
    ...
    def idmap_opvl_water_hymos(self) -> IdMappingDataframe:
        ...
        file_path = self.get_idmap_file_path(idmap=IdMapChoices.idmap_opvl_water_hymos)
        self._id_opvl_water_hymos = self.get_idmap_df(idmap=IdMapChoices.idmap_opvl_water_hymos, file_path=file_path)
        return self._id_opvl_water_hymos
    ...
    def idmap_hdsr_nsc(self) -> IdMappingDataframe:
        ...
        file_path = self.get_idmap_file_path(idmap=IdMapChoices.idmap_hdsr_nsc)
        self._id_hdsr_nsc = self.get_idmap_df(idmap=IdMapChoices.idmap_hdsr_nsc, file_path=file_path)
        return self._id_hdsr_nsc
    ...
    def idmap_opvl_water_wq(self) -> IdMappingDataframe:
        ...
        file_path = self.get_idmap_file_path(idmap=IdMapChoices.idmap_opvl_water_wq)
        self._id_opvl_water_wq = self.get_idmap_df(idmap=IdMapChoices.idmap_opvl_water_wq, file_path=file_path)
        return self._id_opvl_water_wq
    ...
    def idmap_grondwater_caw(self) -> IdMappingDataframe:
        ...
        file_path = self.get_idmap_file_path(idmap=IdMapChoices.idmap_grondwater_caw)
        self._id_grondwater_caw = self.get_idmap_df(idmap=IdMapChoices.idmap_grondwater_caw, file_path=file_path)
        return self._id_grondwater_caw
    ...
    def get_idmap_file_path(self, idmap: IdMapChoices) -> Path:
        file_name = idmap.value
        file_path = self.fews_config.IdMapFiles[file_name]
        return file_path

    @classmethod
    def get_idmap_df(cls, idmap: IdMapChoices, file_path: Path) -> IdMappingDataframe:
        assert isinstance(idmap, IdMapChoices)
        assert isinstance(file_path, Path) and file_path.is_file()
