...
class SigScanner:
    ...
    def copy_files_to_dir(self):
        ...
        for each_file in tqdm.tqdm(self.files_to_tar, total=len(self.files_to_tar)):
            try:
                dest_filepath = self.sig_files_output_path + each_file
    ...
    def build_sig_scanner_command(self):
        ...
        output_dir = self.sig_files_output_path if self.expand_sig_files else (self.sig_scan_tar_output_directory)
