...
class GraphFrame:
    ...
    def __init__(
        ...
        self.inclusive_suffix = inclusive_suffix
    ...
    def filter(self, filter_obj, squash=True, num_procs=mp.cpu_count()):
        ...
        filtered_gf.inclusive_suffix = self.inclusive_suffix
    ...
    def update_inclusive_columns(self):
        ...
        self.inc_metrics = [
            "%s%s" % (s, self.inclusive_suffix) for s in self.exc_metrics
        ]
