    ...
    def add_track_condition_to_map(self, m: Map, hide_good_sections: bool = False) -> Map:
        for trk_con in self.trk_conds:
            ...
            if not hide_good_sections:
                ...
                good_markers = [CircleMarker(location=(lat, lon), radius=5, fill_color='#57AB27', color='#000000')
            ...
            okay_markers = [CircleMarker(location=(lat, lon), radius=5, fill_color='#57AB27', color='#000000')
            ...
            bad_markers = [CircleMarker(location=(lat, lon), radius=5, fill_color='#57AB27', color='#000000')
                           for lat, lon in zip(trk_con_okay['lat'], trk_con_bad['lon'])]
