...
class ProjectMeta(BaseModel):
    ...
    custom_path: Text = ""
    custom_py: List = []  # custom.py file path
    self_path: Text = ""
    self_py: Text = ""  # self_py file
...
class DataCorrelationEnum(BaseModel):
    ...
    SUPPORT_TYPES: List = [MYSQL, REDIS, MONGO, ES]
