...
class MLModel(BaseModel):
    id: basic.Uuid = Field(..., description='Unique identifier of a MLModel instance.')
    name: constr(min_length=1, max_length=64) = Field(
        ..., description='Name that identifies this MLModel.'
    )
    fullyQualifiedName: Optional[constr(min_length=1, max_length=64)] = Field(
        None, description='A unique name that identifies a MLModel.'
    )
    displayName: Optional[str] = Field(
        None, description='Display Name that identifies this MLModel.'
    )
    description: Optional[str] = Field(
        None, description='Description of the MLModel, what it is, and how to use it.'
    )
    algorithm: str = Field(..., description='Algorithm used to train the MLModel.')
    ...
    owner: Optional[entityReference.EntityReference] = Field(
        None, description='Owner of this MLModel.'
    )
    followers: Optional[entityReference.EntityReferenceList] = Field(
        None, description='Followers of this MLModel.'
    )
    tags: Optional[List[tagLabel.TagLabel]] = Field(
        None, description='Tags for this MLModel.'
    )
    usageSummary: Optional[usageDetails.TypeUsedToReturnUsageDetailsOfAnEntity] = Field(
        None, description='Latest usage information for this MLModel.'
    )
