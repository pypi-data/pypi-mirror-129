...
from .models.product	import UnileverSiteMercadoProduct, UnileverSiteMercadoProductPrice, UnileverSiteMercadoProductStock
...
class UnileverSiteMercadoController:
	...
	@AttemptRequests(success_codes=[200])
	def post_product(self, products:List[UnileverSiteMercadoProduct]):
	...
	@AttemptRequests(success_codes=[200])
	def post_product_stock(self, product_stock:List[UnileverSiteMercadoProductStock]):
	...
	@AttemptRequests(success_codes=[200])
	def post_product_price(self, product_price:UnileverSiteMercadoProductPrice):
