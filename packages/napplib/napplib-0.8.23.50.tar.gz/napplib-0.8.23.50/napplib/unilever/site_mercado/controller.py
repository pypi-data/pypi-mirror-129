...
class UnileverSiteMercadoController:
	...
	@AttemptRequests(success_codes=[200])
	def post_product(self, token: str, product_list:UnileverSiteMercadoProductList):
	...
	@AttemptRequests(success_codes=[200])
	def post_product_stock(self, token: str, product_stock_list:UnileverSiteMercadoProductStockList):
		self.__set_header_authorization(token)
	...
	@AttemptRequests(success_codes=[200])
	def post_product_price(self, token: str, product_price_list:UnileverSiteMercadoProductPriceList):
		self.__set_header_authorization(token)
