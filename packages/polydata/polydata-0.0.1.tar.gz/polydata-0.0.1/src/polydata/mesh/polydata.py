# -*- coding: utf-8 -*-
from polydata.core.types import Hierarchy
from polydata.math.array import isfloatarray, isintegerarray
from polydata.mesh.utils import cell_coords_bulk, \
    detach_mesh_bulk as detach_mesh, cell_center_bulk
from polydata.mesh.vtkutils import mesh_to_vtk
from polydata.mesh.polygon import Triangle
from polydata.mesh.Q4 import Q4 as Quadrilateral
from polydata.mesh.polyhedron import HexaHedron, Wedge, TriquadraticHexaHedron
from polydata.mesh.utils import index_of_closest_point, nodal_distribution_factors
from polydata.mesh.topo import regularize, nodal_adjacency, cells_at_nodes
