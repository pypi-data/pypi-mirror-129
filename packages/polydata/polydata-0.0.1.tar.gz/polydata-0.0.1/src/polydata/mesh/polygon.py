...
from polydata.mesh.tri.triutils import area_tri_bulk
from polydata.mesh.topo.tr import T6_to_T3, Q4_to_T3, Q9_to_Q4
from polydata.mesh.cell import PolyCell2d
import numpy as np
