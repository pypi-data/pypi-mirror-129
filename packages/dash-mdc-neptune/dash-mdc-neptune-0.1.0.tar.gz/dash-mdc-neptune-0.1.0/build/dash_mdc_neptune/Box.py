...
- sx (dict; optional):
    ...
    @_explicitize_args
    def __init__(self, children=None, id=Component.UNDEFINED, sx=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'sx']
        self._type = 'Box'
        self._namespace = './build/dash_mdc_neptune'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'sx']
