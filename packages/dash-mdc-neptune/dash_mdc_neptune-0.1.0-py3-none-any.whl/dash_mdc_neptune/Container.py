...
- maxWidth (string; default 'sm'):
    ...
    @_explicitize_args
    def __init__(self, children=None, id=Component.UNDEFINED, maxWidth=Component.UNDEFINED, fixed=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'fixed', 'maxWidth']
        self._type = 'Container'
        self._namespace = './build/dash_mdc_neptune'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'fixed', 'maxWidth']
