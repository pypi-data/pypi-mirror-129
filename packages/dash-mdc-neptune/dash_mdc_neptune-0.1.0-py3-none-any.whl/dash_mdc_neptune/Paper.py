...
- square (boolean; default False):
    ...
    @_explicitize_args
    def __init__(self, children=None, id=Component.UNDEFINED, elevation=Component.UNDEFINED, square=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'elevation', 'square']
        self._type = 'Paper'
        self._namespace = './build/dash_mdc_neptune'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'elevation', 'square']
