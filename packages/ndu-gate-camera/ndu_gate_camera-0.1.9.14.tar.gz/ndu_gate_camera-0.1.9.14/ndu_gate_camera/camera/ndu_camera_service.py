...
class NDUCameraService(Thread):
    def __init__(self, instance=None, config_dir="", handler=None, is_main_thread=True, extension_folder=None, config_file="", timestamp=""):
    ...
    def _run(self):
        ...
        try:
            ...
            for _frame_index, frame in self.video_source.get_frames():
                if self.__result_handler.get_restart_required():
                    self._exit_requested = True
                    '''
                    try:
