...
class ResultHandlerMqtt:
    ...
    def create_default_conf(self, runner_conf):
        ...
        for item in files:
            ...
            if item in runner_conf and extension == 'json':
                try:
                    shutil.copy(os.path.join(config_path, item+'.'+extension), os.path.join(config_path, runner_conf))
    ...
    def post_frame(self, f):
        ...
        try:
            ...
            response = requests.post('http://' + self.host + ':8080/api/v1/' + self.access_token + '/attributes',
