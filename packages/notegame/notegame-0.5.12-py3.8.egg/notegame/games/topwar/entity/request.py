...
class ActionRequest:
    ...
    @staticmethod
    def login(token=None, version="1.231.2", k=1554):
        if token is None:
    ...
    @staticmethod
    def connect(version="1.231.2", server_id=1554, token=None):
        p = {
            "token": token,
            "country": "CN",
            "lang": "zh_cn",
    ...
    def map_search(min_level=78, max_level=85, group_type=42, point_type=1):
        # {"c":906,"o":"109","p":{"minLevel":78,"maxLevel":78,"groupType":42,"pointType":1}}
