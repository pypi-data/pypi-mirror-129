...
class Person:
    ...
    def from_dict(obj: Any) -> 'Person':
        ...
        return Person(created_at, id, activity, person_created_at, deleted_at, entity_type, person_id, last_modified_at, logical_id, organization, password, properties, slack_profile)
