...
[boto3.CloudWatchEvidently 1.20.16](https://boto3.amazonaws.com/v1/documentation/api/1.20.16/reference/services/evidently.html#CloudWatchEvidently)
...
- Install `boto-stubs[evidently]` in your environment:
  `python -m pip install 'boto3-stubs[evidently]'`
