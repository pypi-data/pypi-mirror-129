...
def create_layout(children):
    layout = html.Div([
        ...
        html.Div(
            [html.Div(
                [html.Div(
                    [html.Button(id='pulldatascope', children='Pull the data into Scope app',
        ...
        html.Div([
            html.Div([
                ...
                dbc.Input(id="llc", type="number", value=10, persistence=True),
            ], className='col-6'),

            html.Div([
                html.P(['Number of LLC intervals to buffer (+/-) the trace:']),
                dbc.Input(id="buffer", type="number", value=10, persistence=True),
            ], className='col-6'),
        ...
        html.Div(id='scopeplots', children=children,
