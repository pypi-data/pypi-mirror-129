...
topodatatable = corecallbacks.populatetoporeport() # this is a terrible way to do this... need a constructor function
...
# scope_app.register_callbacks()
# dashboard_app.register_callbacks()
# interscan_app.register_callbacks()
