...
def get_command_line_arguments(args=None):
    ...
    parser.add_argument('-c', '--credentials', default=None, action="store_true",
                        help='update qualys api user credentials stored on disk: qualys uername, password or api_fqdn_server')
...
def main():
    ...
    if if_stdin_credentials():
        pass
    elif if_prompt_credentials():
        pass
    elif if_memory_credentials():
        pass
    elif if_update_credentials():
        pass
