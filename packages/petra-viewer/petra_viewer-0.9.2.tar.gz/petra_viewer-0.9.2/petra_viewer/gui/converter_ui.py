...
class Ui_Converter(object):
    def setupUi(self, Converter):
        ...
        self.dsb_det_r.setProperty("value", -0.333)
        ...
        self.dsb_det_rt.setProperty("value", 145.2)
        ...
        self.dsb_det_t.setProperty("value", 5.029)
        ...
        self.dsb_shift_gamma.setProperty("value", 1.97)
        ...
        self.dsb_shift_phi.setProperty("value", 45.8)
        ...
        self.gridLayout_5.addWidget(self.sb_bin_x, 0, 0, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.sb_bin_y, 0, 1, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.sb_bin_z, 0, 2, 1, 1)
