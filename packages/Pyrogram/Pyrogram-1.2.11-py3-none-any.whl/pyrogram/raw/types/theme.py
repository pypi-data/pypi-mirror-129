...
class Theme(TLObject):  # type: ignore
    ...
    def __init__(self, *, id: int, access_hash: int, slug: str, title: str, creator: Union[None, bool] = None, default: Union[None, bool] = None, for_chat: Union[None, bool] = None, document: "raw.base.Document" = None, settings: "raw.base.ThemeSettings" = None, installs_count: Union[None, int] = None) -> None:
        self.id = id  # long
