...
from bf_nlu.nlu.extractors.extractor import EntityExtractor
...
from bf_nlu.nlu.config import bf_nluNLUModelConfig, InvalidConfigError
...
class DIETClassifier(IntentClassifier, EntityExtractor):
    ...
    def _create_model_data(
        ...
        model_data = bf_nluModelData(label_key=self.label_key)
    ...
    def _load_model(
        ...
        model_data_example = bf_nluModelData(label_key=label_key, data=data_example)
