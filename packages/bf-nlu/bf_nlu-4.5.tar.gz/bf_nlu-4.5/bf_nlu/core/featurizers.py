...
from bf_nlu.core.domain import PREV_PREFIX, Domain
...
class TrackerFeaturizer:
    ...
    def persist(self, path) -> None:
        ...
        bf_nlu.utils.io.create_directory_for_file(featurizer_file)

        # noinspection PyTypeChecker
        bf_nlu.utils.io.write_text_file(str(jsonpickle.encode(self)), featurizer_file)
    ...
    def load(path) -> Optional["TrackerFeaturizer"]:
        ...
        if os.path.isfile(featurizer_file):
            return jsonpickle.decode(bf_nlu.utils.io.read_file(featurizer_file))
        else:
            logger.error(
