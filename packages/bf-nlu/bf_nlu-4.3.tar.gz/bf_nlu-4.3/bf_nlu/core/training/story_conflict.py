...
from bf_nlu.core.events import ActionExecuted, Event
from bf_nlu.core.featurizers import MaxHistoryTrackerFeaturizer
from bf_nlu.nlu.constants import INTENT
from bf_nlu.core.training.generator import TrackerWithCachedStates
    ...
    def _summarize_conflicting_actions(action: Text, stories: List[Text]) -> Text:
        ...
        if len(stories) > 3:
            ...
            raise ValueError(
                ...
                "Please file a bug report at https://github.com/bf_nluHQ/bf_nlu."
            )
