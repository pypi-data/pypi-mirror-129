...
from bf_nlu.nlu.config import bf_nluNLUModelConfig, override_defaults
...
from bf_nlu.nlu.constants import TEXT, SPACY_DOCS, DENSE_FEATURIZABLE_ATTRIBUTES
...
class SpacyNLP(Component):
    ...
    def train(
        self, training_data: TrainingData, config: bf_nluNLUModelConfig, **kwargs: Any
    ) -> None:
