...
import typing
import bf_nlu.utils.common as bf_nlu_utils
...
def _parse_gpu_config(gpu_memory_config: Text) -> Dict[int, int]:
    ...
    try:
        ...
        raise ValueError(
            ...
            f"at https://bf_nlu.com/docs/bf_nlu/api/tensorflow_usage.html#restricting-absolute-gpu-memory-available ."
        )
