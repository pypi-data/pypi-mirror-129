...
class TrainingDataImporter:
    ...
    def load_from_dict(
        ...
        from bf_nlu.importers.bf_nlu import bf_nluFileImporter
    ...
    def _importer_from_dict(
        ...
        from bf_nlu.importers.multi_project import MultiProjectImporter
        from bf_nlu.importers.bf_nlu import bf_nluFileImporter

        module_path = importer_config.pop("name", None)
        if module_path == bf_nluFileImporter.__name__:
            importer_class = bf_nluFileImporter
