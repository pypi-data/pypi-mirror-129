...
from bf_nlu.constants import DOCS_URL_TRAINING_DATA_NLU
...
from bf_nlu.nlu.featurizers.featurizer import SparseFeaturizer
    ...
    def _generate_lookup_regex(
        ...
        if isinstance(lookup_elements, list):
            ...
            common_utils.raise_warning(
                f"Directly including lookup tables as a list is deprecated since bf_nlu "
                f"1.6.",
                FutureWarning,
        ...
        # otherwise it's a file path.
            ...
            try:
                f = open(lookup_elements, "r", encoding=bf_nlu.utils.io.DEFAULT_ENCODING)
            except OSError:
                raise ValueError(
    ...
    def load(
        ...
        **kwargs: Any,
        ...
        if os.path.exists(regex_file):
            known_patterns = bf_nlu.utils.io.read_json_file(regex_file)
