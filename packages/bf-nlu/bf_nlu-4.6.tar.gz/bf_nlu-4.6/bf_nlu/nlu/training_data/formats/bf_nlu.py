...
from bf_nlu.constants import DOCS_BASE_URL, DOCS_URL_TRAINING_DATA_NLU
from bf_nlu.nlu.training_data.formats.readerwriter import (
    JsonTrainingDataReader,
    TrainingDataWriter,
)
from bf_nlu.nlu.training_data.util import transform_entity_synonyms
from bf_nlu.nlu.utils import json_to_string
...
def validate_bf_nlu_nlu_data(data: Dict[Text, Any]) -> None:
    ...
    try:
        validate(data, _bf_nlu_nlu_data_schema())
...
def _bf_nlu_nlu_data_schema() -> Dict[Text, Any]:
