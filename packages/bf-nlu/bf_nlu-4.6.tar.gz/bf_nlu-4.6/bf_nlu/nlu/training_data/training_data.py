...
from bf_nlu.utils.common import raise_warning, lazy_property
from bf_nlu.nlu.constants import RESPONSE, RESPONSE_KEY_ATTRIBUTE
from bf_nlu.nlu.training_data.message import Message
from bf_nlu.nlu.training_data.util import check_duplicate_synonym
from bf_nlu.nlu.utils import list_to_str
...
class TrainingData:
    ...
    def __hash__(self) -> int:
        from bf_nlu.core import utils as core_utils
    ...
    def nlu_as_json(self, **kwargs: Any) -> Text:
        ...
        from bf_nlu.nlu.training_data.formats import (  # pytype: disable=pyi-error
            bf_nluWriter,
        )
    ...
    def persist_nlu(self, filename: Text = DEFAULT_TRAINING_DATA_OUTPUT_PATH):
        ...
        if filename.endswith("json"):
            bf_nlu.nlu.utils.write_to_file(filename, self.nlu_as_json(indent=2))
        elif filename.endswith("md"):
            bf_nlu.nlu.utils.write_to_file(filename, self.nlu_as_markdown())
        else:
            ValueError(
    ...
    def persist_nlg(self, filename: Text) -> None:
        ...
        bf_nlu.nlu.utils.write_to_file(filename, self.nlg_as_markdown())
