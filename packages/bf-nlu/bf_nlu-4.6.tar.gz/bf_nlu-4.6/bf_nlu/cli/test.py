...
import bf_nlu.utils.validation as validation_utils
...
def test_core(args: argparse.Namespace) -> None:
    ...
    from bf_nlu.test import test_core_models_in_directory, test_core, test_core_models
...
def test_nlu(args: argparse.Namespace) -> None:
    from bf_nlu import data
    from bf_nlu.test import compare_nlu_models, perform_nlu_cross_validation, test_nlu
