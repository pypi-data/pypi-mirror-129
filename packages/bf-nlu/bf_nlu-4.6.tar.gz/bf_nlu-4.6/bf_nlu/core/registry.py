...
def policy_from_module_path(module_path: Text) -> Type["Policy"]:
    ...
    from bf_nlu.utils.common import class_from_module_path

    try:
        return class_from_module_path(
            module_path, lookup_path="bf_nlu.core.policies.registry"
        )
    except ImportError:
...
def featurizer_from_module_path(module_path: Text) -> Type["TrackerFeaturizer"]:
    ...
    try:
        return class_from_module_path(module_path, lookup_path="bf_nlu.core.featurizers")
    except ImportError:
