...
from bf_nlu.core.actions.action import ACTION_LISTEN_NAME, ACTION_SESSION_START_NAME
...
class StoryGraph:
    ...
    def visualize(self, output_file: Optional[Text] = None) -> "nx.MultiDiGraph":
        import networkx as nx
        from bf_nlu.core.training import visualization  # pytype: disable=pyi-error
