...
from bf_nlu.core.actions.action import ACTION_LISTEN_NAME
from bf_nlu.core.brokers.broker import EventBroker
from bf_nlu.core.conversation import Dialogue
from bf_nlu.core.domain import Domain
from bf_nlu.core.events import SessionStarted
from bf_nlu.core.trackers import ActionExecuted, DialogueStateTracker, EventVerbosity
from bf_nlu.utils.common import class_from_module_path, raise_warning, arguments_of
...
class TrackerStore:
    ...
    def create_tracker_store(
        ...
        raise_warning(
            ...
            "removed in future bf_nlu versions.",
            DeprecationWarning,
        )
    ...
    def _deserialise_dialogue_from_pickle(
        ...
        logger.warning(
            ...
            f"trackers will be deprecated in version 2.0. bf_nlu will perform any "
...
def _create_sequence(table_name: Text) -> Sequence:
    ...
    https://bf_nlu.com/docs/bf_nlu/api/tracker-stores/#sqltrackerstore
    Args:
