...
from bf_nlu.core.events import UserUttered, ActionExecuted

from bf_nlu.core.constants import USER_INTENT_OUT_OF_SCOPE
from bf_nlu.core.domain import Domain, InvalidDomain
from bf_nlu.core.policies.fallback import FallbackPolicy
from bf_nlu.core.policies.policy import confidence_scores_for
from bf_nlu.core.trackers import DialogueStateTracker
from bf_nlu.core.constants import FALLBACK_POLICY_PRIORITY

if typing.TYPE_CHECKING:
    from bf_nlu.core.policies.ensemble import PolicyEnsemble
...
class TwoStageFallbackPolicy(FallbackPolicy):
    ...
    def persist(self, path: Text) -> None:
        ...
        bf_nlu.utils.io.create_directory_for_file(config_file)
        bf_nlu.utils.io.dump_obj_as_json_to_file(config_file, meta)
    ...
    def load(cls, path: Text) -> "FallbackPolicy":
        ...
        if os.path.exists(path):
            ...
            if os.path.isfile(meta_path):
                meta = json.loads(bf_nlu.utils.io.read_file(meta_path))
