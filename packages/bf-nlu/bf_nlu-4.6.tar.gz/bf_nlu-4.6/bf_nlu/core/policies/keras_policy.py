...
from bf_nlu.core.featurizers import (
    MaxHistoryTrackerFeaturizer,
    BinarySingleStateFeaturizer,
)
from bf_nlu.core.featurizers import TrackerFeaturizer
from bf_nlu.core.policies.policy import Policy
from bf_nlu.core.trackers import DialogueStateTracker
import bf_nlu.utils.common as common_utils
from bf_nlu.core.constants import DEFAULT_POLICY_PRIORITY
...
class KerasPolicy(Policy):
    ...
    def persist(self, path: Text) -> None:
        ...
        if self.model:
            ...
            bf_nlu.utils.io.dump_obj_as_json_to_file(meta_file, meta)

            model_file = os.path.join(path, meta["model"])
            # makes sure the model directory exists
            bf_nlu.utils.io.create_directory_for_file(model_file)
    ...
    def load(cls, path: Text) -> "KerasPolicy":
        ...
        if os.path.exists(path):
            ...
            if os.path.isfile(meta_file):
                meta = json.loads(bf_nlu.utils.io.read_file(meta_file))
