...
from bf_nlu.core.constants import DEFAULT_POLICY_PRIORITY, DIALOGUE
...
class TEDPolicy(Policy):
    ...
    def _create_model_data(
        ...
        model_data = bf_nluModelData(label_key=LABEL_IDS)
    ...
    def _create_label_data(self, domain: Domain) -> bf_nluModelData:
    ...
    def load(cls, path: Text) -> "TEDPolicy":
        ...
        **Needs to load its featurizer**
        ...
        model_data_example = bf_nluModelData(label_key=LABEL_IDS, data=loaded_data)
