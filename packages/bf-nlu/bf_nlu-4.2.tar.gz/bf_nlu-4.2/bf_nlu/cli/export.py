...
import bf_nlu.core.utils as bf_nlu_core_utils
from bf_nlu.cli.arguments import export as arguments
from bf_nlu.constants import DOCS_URL_TRACKER_STORES, DOCS_URL_EVENT_BROKERS
...
if typing.TYPE_CHECKING:
    ...
    from bf_nlu.core.brokers.pika import PikaEventBroker, PikaProducer
...
def export_trackers(args: argparse.Namespace) -> None:
    ...
    endpoints = bf_nlu_core_utils.read_endpoints_from_path(args.endpoints)
