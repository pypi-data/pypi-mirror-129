...
from bf_nlu.core import events  # pytype: disable=pyi-error
from bf_nlu.core.actions.action import ACTION_LISTEN_NAME  # pytype: disable=pyi-error
from bf_nlu.core.conversation import Dialogue  # pytype: disable=pyi-error
from bf_nlu.core.events import (  # pytype: disable=pyi-error
    UserUttered,
    ActionExecuted,
    Event,
    SlotSet,
...
from bf_nlu.core.domain import Domain  # pytype: disable=pyi-error
from bf_nlu.core.slots import Slot
...
class DialogueStateTracker:
    ...
    def export_stories(self, e2e: bool = False) -> Text:
        ...
        from bf_nlu.core.training.structures import Story
    ...
    def export_stories_to_file(self, export_path: Text = "debug.md") -> None:
        ...
        bf_nlu.utils.io.write_text_file(
