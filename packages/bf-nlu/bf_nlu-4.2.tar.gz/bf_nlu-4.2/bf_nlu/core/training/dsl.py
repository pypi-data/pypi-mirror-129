...
from bf_nlu.constants import DOCS_BASE_URL, DOCS_URL_STORIES, DOCS_URL_DOMAINS
from bf_nlu.core import utils
from bf_nlu.core.constants import INTENT_MESSAGE_PREFIX
from bf_nlu.core.events import ActionExecuted, UserUttered, Event, SlotSet
from bf_nlu.core.exceptions import StoryParseError
from bf_nlu.core.interpreter import RegexInterpreter, NaturalLanguageInterpreter
from bf_nlu.core.training.structures import (
    Checkpoint,
    STORY_START,
    StoryStep,
...
class EndToEndReader(MarkdownReader):
    ...
    def _parse_item(self, line: Text) -> Optional["Message"]:
        ...
        syntax of <example> see the bf_nlu docs on NLU training data:
        ...
        # are annotated in the json format (e.g. `/greet{"name": "bf_nlu"})
