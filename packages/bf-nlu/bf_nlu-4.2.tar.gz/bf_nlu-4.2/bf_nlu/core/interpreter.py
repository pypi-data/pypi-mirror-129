...
from bf_nlu.constants import DOCS_URL_STORIES
...
from bf_nlu.utils.common import raise_warning, class_from_module_path
...
class NaturalLanguageInterpreter:
    ...
    def create(
        ...
        if isinstance(obj, NaturalLanguageInterpreter):
            ...
            return bf_nluNLUInterpreter(model_directory=obj)
...
class bf_nluNLUHttpInterpreter(NaturalLanguageInterpreter):
    ...
    async def parse(
        ...
        result = await self._bf_nlu_http_parse(text, message_id)
...
class bf_nluNLUInterpreter(NaturalLanguageInterpreter):
    def __init__(
        self,
    ...
    def _load_interpreter(self) -> None:
        from bf_nlu.nlu.model import Interpreter
...
def _create_from_endpoint_config(
    ...
    if endpoint_config is None:
        ...
        return bf_nluNLUHttpInterpreter(endpoint_config=endpoint_config)
    else:
