...
from bf_nlu.core.featurizers import MaxHistoryTrackerFeaturizer, TrackerFeaturizer
from bf_nlu.core.policies.policy import Policy
from bf_nlu.core.trackers import DialogueStateTracker
from bf_nlu.core.training.data import DialogueTrainingData
...
class SklearnPolicy(Policy):
    ...
    def persist(self, path: Text) -> None:
        ...
        if self.model:
            ...
            bf_nlu.utils.io.pickle_dump(filename, self._state)
        else:
            raise_warning(
    ...
    def load(cls, path: Text) -> Policy:
        ...
        state = bf_nlu.utils.io.pickle_load(filename)
