...
from bf_nlu.core.events import ActionExecuted
from bf_nlu.core.featurizers import TrackerFeaturizer, MaxHistoryTrackerFeaturizer
from bf_nlu.core.policies.policy import Policy
from bf_nlu.core.trackers import DialogueStateTracker
from bf_nlu.utils.common import is_logging_disabled
from bf_nlu.core.constants import MEMOIZATION_POLICY_PRIORITY
...
class MemoizationPolicy(Policy):
    ...
    def persist(self, path: Text) -> None:
        ...
        bf_nlu.utils.io.create_directory_for_file(memorized_file)
        bf_nlu.utils.io.dump_obj_as_json_to_file(memorized_file, data)
    ...
    def load(cls, path: Text) -> "MemoizationPolicy":
        ...
        if os.path.isfile(memorized_file):
            data = json.loads(bf_nlu.utils.io.read_file(memorized_file))
            return cls(
