...
from bf_nlu.utils.tensorflow.model_data import bf_nluModelData, FeatureSignature
from bf_nlu.utils.tensorflow.constants import SEQUENCE

logger = logging.getLogger(__name__)


# noinspection PyMethodOverriding
class bf_nluModel(tf.keras.models.Model):
    ...
    def build_for_predict(
        self, predict_data: bf_nluModelData, eager: bool = False
    ) -> None:
    ...
    def predict(self, predict_data: bf_nluModelData) -> Dict[Text, tf.Tensor]:
    ...
    @classmethod
    def load(
        cls, model_file_name: Text, model_data_example: bf_nluModelData, *args, **kwargs
    ) -> "bf_nluModel":
    ...
    def _get_tf_train_functions(
        self, eager: bool, model_data: bf_nluModelData, batch_strategy: Text
    ...
    def _get_tf_evaluation_functions(
        self, eager: bool, evaluation_model_data: Optional[bf_nluModelData]
