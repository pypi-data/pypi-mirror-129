...
from bf_nlu.nlu.training_data.formats import markdown
from bf_nlu.nlu.training_data.formats.dialogflow import (
    DIALOGFLOW_AGENT,
    DIALOGFLOW_ENTITIES,
...
if typing.TYPE_CHECKING:
    ...
    from bf_nlu.nlu.training_data.formats.readerwriter import TrainingDataReader
...
_json_format_heuristics = {
    ...
    bf_nlu: lambda js, fn: "bf_nlu_data" in js,
...
def _reader_factory(fformat: Text) -> Optional["TrainingDataReader"]:
    ...
    from bf_nlu.nlu.training_data.formats import (
        MarkdownReader,
        WitReader,
        LuisReader,
        bf_nluReader,
...
def _guess_format(filename: Text) -> Text:
    logger.warning(
        "Using '_guess_format()' is deprecated since bf_nlu 1.1.5. "
