...
from bf_nlu.constants import DOCS_URL_MIGRATION_GUIDE
from bf_nlu.nlu.config import bf_nluNLUModelConfig, override_defaults, InvalidConfigError
...
def validate_requirements(component_names: List[Text]) -> None:
    ...
    from bf_nlu.nlu import registry
...
def validate_empty_pipeline(pipeline: List["Component"]) -> None:
    ...
    Args:
        pipeline: the list of the :class:`bf_nlu.nlu.components.Component`.
    """
...
def _check_deprecated_attributes(component: "Component") -> None:
    ...
    Args:
        component: The :class:`bf_nlu.nlu.components.Component`.
    """
...
def validate_required_components_from_data(
    ...
    Args:
        pipeline: The list of the :class:`bf_nlu.nlu.components.Component`.
        data: The :class:`bf_nlu.nlu.training_data.training_data.TrainingData`.
    """
...
class Component(metaclass=ComponentMetaclass):
    ...
    def load(
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            model_metadata: The model's :class:`bf_nlu.nlu.model.Metadata`.
    ...
    @classmethod
    def create(
        cls, component_config: Dict[Text, Any], config: bf_nluNLUModelConfig
    ) -> "Component":
    ...
    def train(
        ...
        **kwargs: Any,
        ...
        :meth:`bf_nlu.nlu.components.Component.train`
        of components previous to this one.

        Args:
            training_data:
                The :class:`bf_nlu.nlu.training_data.training_data.TrainingData`.
            config: The model configuration parameters.
    ...
    def process(self, message: Message, **kwargs: Any) -> None:
        ...
        Args:
            message: The :class:`bf_nlu.nlu.training_data.message.Message` to process.
    ...
    def cache_key(
        ...
        Args:
            ...
            model_metadata: The component's :class:`bf_nlu.nlu.model.Metadata`.
    ...
    def partially_process(self, message: Message) -> Message:
        ...
        Returns:
            The processed :class:`bf_nlu.nlu.training_data.message.Message`.
...
class ComponentBuilder:
    ...
    def load_component(
        ...
        **context: Any,
        ...
        Args:
            ...
            model_metadata (Metadata):
                The model's :class:`bf_nlu.nlu.model.Metadata`.
    ...
    def create_component(
        self, component_config: Dict[Text, Any], cfg: bf_nluNLUModelConfig
    ) -> Component:
        """Creates a component.
