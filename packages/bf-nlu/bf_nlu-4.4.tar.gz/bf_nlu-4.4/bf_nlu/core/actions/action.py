...
from bf_nlu.core import events
...
if typing.TYPE_CHECKING:
    ...
    from bf_nlu.core.events import SlotSet
...
class Action:
    ...
    async def run(
        ...
        Returns:
            List[Event]: A list of :class:`bf_nlu.core.events.Event` instances
        """
...
class ActionRestart(ActionUtterTemplate):
    ...
    async def run(
        ...
        from bf_nlu.core.events import Restarted
...
class ActionDefaultFallback(ActionUtterTemplate):
    ...
    async def run(
        ...
        from bf_nlu.core.events import UserUtteranceReverted
...
class ActionDeactivateForm(Action):
    ...
    async def run(
        ...
        from bf_nlu.core.events import Form, SlotSet
...
class RemoteAction(Action):
    ...
    def _action_call_format(
        ...
        from bf_nlu.core.trackers import EventVerbosity
