...
from bf_nlu.core.channels.channel import CollectingOutputChannel, UserMessage
        ...
        if isinstance(event, UserUttered):
            ...
            for m in out.messages:
                ...
                if buttons is not None:
                    color = bf_nlu.cli.utils.bcolors.OKBLUE
                    bf_nlu.cli.utils.print_color("Buttons:", color=color)
                    for idx, button in enumerate(buttons):
                        bf_nlu.cli.utils.print_color(
...
def load_tracker_from_json(tracker_dump: Text, domain: Domain) -> DialogueStateTracker:
    ...
    tracker_json = json.loads(bf_nlu.utils.io.read_file(tracker_dump))
