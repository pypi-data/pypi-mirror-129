...
from bf_nlu.nlu import config, training_data, utils
...
from bf_nlu.nlu.model import Interpreter, Trainer, TrainingData
...
def cross_validate(
    data: TrainingData,
    n_folds: int,
    nlu_config: Union[bf_nluNLUModelConfig, Text],
...
def compare_nlu(
    ...
    from bf_nlu.train import train_nlu
...
if __name__ == "__main__":
    raise RuntimeError(
        "Calling `bf_nlu.nlu.test` directly is no longer supported. Please use "
