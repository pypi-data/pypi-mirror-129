        ...
        if self.Rnd_week_trips != 0:
            ...
            while True:
                ...
                if self.flag:
                    continue
                if self.flagiter:
                    logger.info(f"  Tour done: Day {str(self.days)}")
                break
        ...
        if self.flag:
            ...
            if (
                ...
                if not self.flagiter:
                    self.flagiter = True
                logger.info(f"    Day {str(self.days)} 'select_tour' method in loop Nr. {self.warningB}. See log file {self.name}")
                ...
                if self.warningB > 2000:
                    ...
                    logger.info(f"    Unsuccessful tour sample:\n\n\t {df_strings}\n")
