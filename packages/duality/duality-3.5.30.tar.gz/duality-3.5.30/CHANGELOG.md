...
3.5.20 (03/12/2021)
- CLI v1.9 version added.
- error handling resolved and functional.

3.5.21 (03/12/2021)
- CLI v1.10 version added.
- added newline for readability where applicable.
- EOQCLI and DijkstraCLI now also include invalid action notifier + home and restart options.

3.5.22 (03/12/2021)
- CLI v1.11 version added.
- CLI console output commands are now easier to notice.

3.5.23 (03/12/2021)
- CLI v1.12 version added.
- break executes afer function in home and restart.

3.5.24 (03/12/2021)
- CLI v1.13 version added.
- more tests.

3.5.25 (03/12/2021)
- CLI v1.14 version added.
- restart option caused more harm than good so it was removed.

3.5.26 (03/12/2021)
- CLI v1.15 version added.
- loops redefined.

3.5.27 (03/12/2021)
- CLI v1.16 version added.
- resolved risk command issues.

3.5.28 (03/12/2021)
- CLI v1.17 version added.
- automation of non-inputed values.
- resolving home button after simulation setup set to test.

3.5.29 (03/12/2021)
- CLI v1.18 version added.
- automation of non-inputed values redefined.
- breaking out of a loop redefined.

3.5.30 (03/12/2021)
- CLI v1.19 version added.
- loop configuration put to test.