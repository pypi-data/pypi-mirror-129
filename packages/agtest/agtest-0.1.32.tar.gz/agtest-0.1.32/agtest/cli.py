...
def validate(item):
    ...
    if item == "logs":
        ...
        json_log_filename = os.path.expanduser('~\\Desktop\\install_log_history.json')
...
@click.options('--edtlite', '-el', is_flag=True, help='Will apply temp and internal vouchers and register the install'
                                                      'as EDT Lite')
