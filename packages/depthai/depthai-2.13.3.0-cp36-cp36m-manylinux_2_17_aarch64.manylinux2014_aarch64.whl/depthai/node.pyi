...
class EdgeDetector(depthai.Node):
    ...
    def setWaitForConfigInput(self, arg0: bool) -> None: ...
    @property
...
class ObjectTracker(depthai.Node):
    class Properties:
        ...
        trackerIdAssigmentPolicy: depthai.TrackerIdAssigmentPolicy
    ...
    def setTrackerIdAssigmentPolicy(self, type: depthai.TrackerIdAssigmentPolicy) -> None: ...
...
class StereoDepth(depthai.Node):
    ...
    @overload
    def setDepthAlign(self, align) -> None: ...
    @overload
