...
class SqlCase(object):
    ...
    @staticmethod
    def get_count_fail_from_data(paras: dict = None) -> str:
        """
        查询指定日期里所有失败的用例数量
        """
        # 处理参数
    ...
    @staticmethod
    def get_count_from_tid(paras: dict = None) -> str:
        """
        查询指定任务下所有用例数量
    ...
    @staticmethod
    def get_count_form_date(paras: dict = None) -> str:
        """
        查询指定执行日期的用例数量
    ...
    @staticmethod
    def get_info_from_cid(paras: dict = None) -> str:
        """
        查询指定CID的用例详情信息
    ...
    @staticmethod
    def delete_from_cid(paras: dict = None) -> str:
        """
        删除指定CID用例
