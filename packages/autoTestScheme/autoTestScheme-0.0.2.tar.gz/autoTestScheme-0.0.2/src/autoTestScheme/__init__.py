...
from .common import constant, config as config1, logger, common, tmp
...
def pytest_configure(config):
    ...
    if uuid is not None:
        ...
        a.run_data = config1.Json(_path).get_object()
        start_data.TEST_ENV = a.run_data.get('__env')
