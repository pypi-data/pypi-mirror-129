...
def test_postprocessing_video_disabled_till_end():
    """
...
def test_postprocessing_video_enabled_till_end():
    """
...
def test_postprocessing_video_enabled_till_end_one_frame():
    """
    Test frames extraction with enabled in the end and frame count > enabled key frame
    """
    example = [
...
def test_postprocessing_video_disabled_till_end_one_frame():
    """
...
def test_postprocessing_video_disabled_till_end_2_parts():
    """
    Test frames extraction with disabled in the end and frame count > disabled key frame
    """
    example = [
