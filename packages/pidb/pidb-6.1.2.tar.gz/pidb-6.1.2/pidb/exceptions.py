...
class PIDBError(Exception):
    pass


class PIDBHTTPError(PIDBError, HTTPException):
    """
...
class CouldNotFindResourceError(PIDBHTTPError):
    """
...
class InvalidArgumentsError(PIDBHTTPError):
    """
