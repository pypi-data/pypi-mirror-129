...
admin_auth = basic_auth_authorization_header("admin", "blaat")
researcher_auth = basic_auth_authorization_header("researcher", "blaat")
user_1_auth = basic_auth_authorization_header("user", "blaat")
datamanager_auth = basic_auth_authorization_header("datamanager", "blaat")
