/*! For license information please see 7ce9c655.js.LICENSE.txt */
"use strict";(self.webpackChunkhome_assistant_frontend=self.webpackChunkhome_assistant_frontend||[]).push([[43235,29485],{14166:(t,i,a)=>{a.d(i,{W:()=>n});var e=function(){return e=Object.assign||function(t){for(var i,a=1,e=arguments.length;a<e;a++)for(var n in i=arguments[a])Object.prototype.hasOwnProperty.call(i,n)&&(t[n]=i[n]);return t},e.apply(this,arguments)};function n(t,i,a){void 0===i&&(i=Date.now()),void 0===a&&(a={});var n=e(e({},o),a||{}),s=(+t-+i)/1e3;if(Math.abs(s)<n.second)return{value:Math.round(s),unit:"second"};var r=s/60;if(Math.abs(r)<n.minute)return{value:Math.round(r),unit:"minute"};var l=s/3600;if(Math.abs(l)<n.hour)return{value:Math.round(l),unit:"hour"};var p=s/86400;if(Math.abs(p)<n.day)return{value:Math.round(p),unit:"day"};var h=new Date(t),m=new Date(i),d=h.getFullYear()-m.getFullYear();if(Math.round(Math.abs(d))>0)return{value:Math.round(d),unit:"year"};var u=12*d+h.getMonth()-m.getMonth();if(Math.round(Math.abs(u))>0)return{value:Math.round(u),unit:"month"};var c=s/604800;return{value:Math.round(c),unit:"week"}}var o={second:45,minute:45,hour:22,day:5}},49075:(t,i,a)=>{a.d(i,{S:()=>s,B:()=>r});a(94604);var e=a(51644),n=a(26110),o=a(84938);const s={observers:["_focusedChanged(receivedFocusFromKeyboard)"],_focusedChanged:function(t){t&&this.ensureRipple(),this.hasRipple()&&(this._ripple.holdDown=t)},_createRipple:function(){var t=o.o._createRipple();return t.id="ink",t.setAttribute("center",""),t.classList.add("circle"),t}},r=[e.P,n.a,o.o,s]},25782:(t,i,a)=>{a(94604),a(65660),a(70019),a(97968);var e=a(9672),n=a(50856),o=a(33760);(0,e.k)({_template:n.d`
    ...
    <slot></slot>
`,is:"paper-icon-item",behaviors:[o.U]})},54444:(t,i,a)=>{a(94604);var e=a(9672),n=a(87156),o=a(50856);(0,e.k)({_template:o.d`
    <style>
      :host {
        display: block;
        position: absolute;
...
//# sourceMappingURL=7ce9c655.js.map