...
@LastEditTime: 2021-12-02 16:54:41
...
class UserAssetListHandler(ClientBaseHandler):
    ...
    def get_async(self):
        ...
        if invoke_result_data.success == False:
            ...
            order_by = invoke_result_data.data["order_by"] if invoke_result_data.data.__contains__("order_by") else ""
        asset_base_model = AssetBaseModel(context=self)
        ref_params = {}
        return self.response_json_success(self.business_process_executed(asset_base_model.get_user_asset_list(app_id, act_id, user_id, asset_type, order_by), ref_params))
