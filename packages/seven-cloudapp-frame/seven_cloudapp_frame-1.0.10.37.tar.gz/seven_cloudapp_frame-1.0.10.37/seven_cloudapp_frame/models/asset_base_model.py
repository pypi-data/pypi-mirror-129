...
@LastEditTime: 2021-12-02 16:50:36
...
class AssetBaseModel():
    ...
    def get_user_asset_list(self, app_id, act_id, user_ids, asset_type=0,order_by=""):
        """
        ...
        user_asset_dict_list = user_asset_model.get_dict_list(condition,order_by=order_by, params=params)
        if len(user_asset_dict_list) > 0:
            for user_asset_dict in user_asset_dict_list:
                user_asset_dict["original_asset_value"] = user_asset_dict["asset_value"]  #仅用于后台显示
