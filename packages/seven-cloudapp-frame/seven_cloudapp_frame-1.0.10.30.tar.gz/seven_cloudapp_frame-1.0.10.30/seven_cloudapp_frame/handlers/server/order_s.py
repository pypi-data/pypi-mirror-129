...
@LastEditTime: 2021-11-29 19:25:18
...
class PrizeOrderListHandler(ClientBaseHandler):
    ...
    def get_async(self):
        ...
        order_base_model = OrderBaseModel(context=self)
        page_list, total = order_base_model.get_prize_order_list(app_id, act_id, user_id, user_open_id, nick_name, order_no, real_name, telephone, address, order_status, create_date_start, create_date_end, page_size, page_index, order_by, is_search_roster=is_search_roster, is_cache=False)
        ref_params = {}
