...
class Client:
    ...
    def resources(
        ...
        """
        return self.__call(
            "resources", [collection_id, include_metas, limit_from, limit_to, order_by]
        )
    ...
    def set_metas_to_collection(self, collection_id: int, metas: List[dict]) -> bool:
        """
        ...
        """
        return self.__call("set_metas_to_collection", [collection_id, metas])
