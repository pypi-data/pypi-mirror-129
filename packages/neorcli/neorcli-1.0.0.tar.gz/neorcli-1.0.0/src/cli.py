...
Usage:
    neor-cli.py [options] update <service_id> --tag <tag>
    neor-cli.py [options] update-mass <base_service_id> <services> [<services>...] --tag <tag>
...
def handle_update(args):
    ...
    image_id = client.create_image(args.tag, image)['id']
...
def handle_mass_update(args):
    ...
    new_base_image_id = client.create_image(args.tag, base_image)['id']
    ...
    for service_id in args.services:
        ...
        if image['id'] == base_image['id']:
            ...
            new_image_id = client.create_image(args.tag, image, base_image_id=new_base_image_id)['id']
