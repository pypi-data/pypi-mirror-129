...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, proxy_password=None, name=None, username=None, client_key=None, sock_read_timeout=None, client_cert=None, headers=None, proxy_url=None, ca_cert=None, password=None, sock_connect_timeout=None, max_retries=None, rate_limit=None, total_timeout=None, proxy_username=None, connect_timeout=None, tls_validation=None, pulp_labels=None, url=None, download_concurrency=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
