...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, name=None, sock_read_timeout=None, client_cert=None, headers=None, pulp_href=None, proxy_url=None, pulp_last_updated=None, ca_cert=None, sock_connect_timeout=None, max_retries=None, rate_limit=None, total_timeout=None, connect_timeout=None, tls_validation=None, pulp_labels=None, url=None, pulp_created=None, download_concurrency=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
