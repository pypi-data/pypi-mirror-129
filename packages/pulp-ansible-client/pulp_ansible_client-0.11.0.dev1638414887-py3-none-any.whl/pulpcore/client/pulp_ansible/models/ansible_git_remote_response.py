...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, tls_validation=None, sock_read_timeout=None, headers=None, rate_limit=None, proxy_url=None, sock_connect_timeout=None, pulp_labels=None, client_cert=None, url=None, max_retries=None, pulp_href=None, download_concurrency=None, total_timeout=None, connect_timeout=None, pulp_created=None, ca_cert=None, name=None, pulp_last_updated=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
