...
class AnsibleGitRemote(object):
    ...
    def __init__(self, tls_validation=None, sock_read_timeout=None, headers=None, rate_limit=None, proxy_username=None, proxy_url=None, proxy_password=None, sock_connect_timeout=None, username=None, pulp_labels=None, client_key=None, client_cert=None, url=None, max_retries=None, download_concurrency=None, total_timeout=None, connect_timeout=None, ca_cert=None, password=None, name=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
