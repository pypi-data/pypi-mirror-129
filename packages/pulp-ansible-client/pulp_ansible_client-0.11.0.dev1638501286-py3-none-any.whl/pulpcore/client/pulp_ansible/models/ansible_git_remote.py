...
class AnsibleGitRemote(object):
    ...
    def __init__(self, max_retries=None, pulp_labels=None, proxy_password=None, ca_cert=None, proxy_username=None, headers=None, connect_timeout=None, url=None, rate_limit=None, client_key=None, sock_connect_timeout=None, total_timeout=None, client_cert=None, sock_read_timeout=None, password=None, download_concurrency=None, proxy_url=None, name=None, username=None, tls_validation=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
