...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, max_retries=None, pulp_labels=None, ca_cert=None, headers=None, connect_timeout=None, url=None, rate_limit=None, sock_connect_timeout=None, total_timeout=None, client_cert=None, pulp_href=None, sock_read_timeout=None, download_concurrency=None, pulp_last_updated=None, proxy_url=None, name=None, pulp_created=None, tls_validation=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
