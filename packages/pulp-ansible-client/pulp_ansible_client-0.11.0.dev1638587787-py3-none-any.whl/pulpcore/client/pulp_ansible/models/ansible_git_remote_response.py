...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, max_retries=None, rate_limit=None, url=None, pulp_labels=None, download_concurrency=None, total_timeout=None, sock_connect_timeout=None, proxy_url=None, headers=None, ca_cert=None, name=None, pulp_last_updated=None, connect_timeout=None, client_cert=None, pulp_created=None, sock_read_timeout=None, tls_validation=None, pulp_href=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
