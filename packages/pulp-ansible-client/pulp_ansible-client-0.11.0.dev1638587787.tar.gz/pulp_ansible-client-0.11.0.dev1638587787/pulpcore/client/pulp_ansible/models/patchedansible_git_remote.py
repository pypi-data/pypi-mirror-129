...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, max_retries=None, rate_limit=None, url=None, password=None, pulp_labels=None, client_key=None, download_concurrency=None, total_timeout=None, proxy_username=None, sock_connect_timeout=None, proxy_url=None, headers=None, ca_cert=None, name=None, proxy_password=None, connect_timeout=None, client_cert=None, username=None, sock_read_timeout=None, tls_validation=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
