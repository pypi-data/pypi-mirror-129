...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, client_cert=None, rate_limit=None, pulp_created=None, connect_timeout=None, ca_cert=None, pulp_last_updated=None, pulp_labels=None, download_concurrency=None, pulp_href=None, headers=None, url=None, total_timeout=None, max_retries=None, sock_connect_timeout=None, name=None, proxy_url=None, sock_read_timeout=None, tls_validation=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
