...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, client_cert=None, rate_limit=None, connect_timeout=None, ca_cert=None, proxy_password=None, pulp_labels=None, download_concurrency=None, headers=None, url=None, total_timeout=None, password=None, max_retries=None, sock_connect_timeout=None, name=None, client_key=None, proxy_url=None, username=None, sock_read_timeout=None, tls_validation=None, proxy_username=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
