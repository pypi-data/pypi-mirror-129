...
def drawVenn2(subsets, labels=default_labels2, alpha=defaultalpha, color=default_color2, unweighted=default_unweighted2):
	if unweighted == 0:
...
def drawVenn3(subsets, labels=default_labels3, alpha=defaultalpha, color=default_color3, unweighted=default_unweighted3):
	if unweighted == 0:
