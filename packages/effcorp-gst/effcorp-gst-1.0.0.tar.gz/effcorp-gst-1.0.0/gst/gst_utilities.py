...
"""
This function gstchecksum will check the last digit of the gst number and return whetherthe Check sum matches or not
...
"""
This fucntion extract pan will extract the pan number from the provided gst_no
...
"""
The function named gstr2a_merge needs only one argument filepath.
So, you have to prvide a complete file path till extension of any one file in that folder

the function will itself read all other .xlsx files in that folder and then do the merging of the files


Also, the format of gstr2a should be exactly same as the one downloaded from the gst site
