    ...
    def __init__(
        ...
        *,
        ...
        options = AutoDiscoverOptions(
            srcdir=srcdir, testdir=testdir, lambda_options=lambda_options
        )
...
class IntegrationTest(
    ...
    def __init__(
        ...
        *,
        ...
        options = IntegrationTestOptions(
            entrypoint=entrypoint, destroy_after_deploy=destroy_after_deploy
        )
    ...
    def assert_task(self) -> _Task_fb843092:
        '''(experimental) Synthesizes the integration test and compares against a local copy (runs during build).

        :stability: experimental
        '''
        return typing.cast(_Task_fb843092, jsii.get(self, "assertTask"))

    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="deployTask")
    def deploy_task(self) -> _Task_fb843092:
        '''(experimental) Deploy the integration test and update the snapshot upon success.

        :stability: experimental
        '''
        return typing.cast(_Task_fb843092, jsii.get(self, "deployTask"))

    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="destroyTask")
    def destroy_task(self) -> _Task_fb843092:
        '''(experimental) Destroys a deployed stack.

        :stability: experimental
        '''
        return typing.cast(_Task_fb843092, jsii.get(self, "destroyTask"))

    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="snapshotTask")
    def snapshot_task(self) -> _Task_fb843092:
        '''(experimental) Just update snapshot (without deployment).

        :stability: experimental
        '''
        return typing.cast(_Task_fb843092, jsii.get(self, "snapshotTask"))
