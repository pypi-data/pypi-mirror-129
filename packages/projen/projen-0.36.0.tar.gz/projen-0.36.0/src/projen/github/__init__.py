...
class GithubWorkflow(
    ...
    @jsii.member(jsii_name="addJobsLater")
    def add_jobs_later(self, provider: "IJobProvider") -> None:
        '''(experimental) Add jobs from a dynamic source.
        ...
        :stability: experimental
        '''
        return typing.cast(None, jsii.invoke(self, "addJobsLater", [provider]))
