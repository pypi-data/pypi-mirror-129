        ...
        for msg in messages:
            ...
            if isinstance(msg.body, (raw.types.BadMsgNotification, raw.types.BadServerSalt)):
                ...
                if isinstance(msg.body, raw.types.RpcResult):
                    if hasattr(msg.body.result, 'pts') and hasattr(msg.body.result, 'date'):
                        if self.client.state:
                            self.client.state.pts = msg.body.result.pts
                            self.client.state.date = msg.body.result.date
                            self.client.on_state_update(self.client.unparse_state(self.client.state))
                ...
                if self.client is not None:
                    ...
                    if hasattr(msg.body, 'updates') and len(msg.body.updates):
                        ...
                        if hasattr(update, 'pts'):
                            if self.client.state:
                                self.client.state.pts = update.pts
                    if hasattr(msg.body, 'date'):
                        if self.client.state:
                            self.client.state.date = msg.body.date
                            self.client.on_state_update(self.client.unparse_state(self.client.state))
