        ...
        if close > up:
            ...
            if pos > 0:
                if self.grace_bar_count == 0 and close < mid:
                    self.set_signal_pos(0)
                elif self.bar_count_since_entry_by_signal <= self.grace_bar_count and close < mid:
                    self.set_signal_pos(0)
                elif self.bar_count_since_entry_by_signal > self.grace_bar_count and close < up:
                    self.set_signal_pos(0)
                ...
                if self.grace_bar_count == 0 and close > mid:
                    ...
                    self.set_signal_pos(0)
                elif self.bar_count_since_entry_by_signal > self.grace_bar_count and close > down:
                    self.set_signal_pos(0)
