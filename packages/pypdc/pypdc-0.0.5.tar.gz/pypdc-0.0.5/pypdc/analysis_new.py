...
from pypdc.ar_data_new import ar_data
from pypdc.ar_fit_new import mvar
import pypdc.asymp_new as as_
from pypdc.plotting_new import *
import pypdc.plotting_new as pl_
import pypdc.bootstrap_new as bt_
...
#=================================================================
#Output the graphics of iPDC results with confidence intervals and
...
#=========================================================
#Output the weighted connectivity matrix (|iPDC|^2 matrix)
...
def pdc_pdc2_th(data, maxp = 20, nf = 64, sample_f = 1,
                   ...
                   stat = 'asymp', n_boot = 1000, fixp = False,
                   plotf = None):
    '''Calculate iPDC and asymptotic statistics from data'''
