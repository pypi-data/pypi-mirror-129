...
def preprocessingData(df, target_names, _portion):
    ...
    def preprocessing(df, target_names, _portion):
    ...
    train_data, test_data, attribute = preprocessing(df.to_numpy(), target_names, _portion)
