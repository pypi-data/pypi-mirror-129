...
PLAYER_SPRITE = file_path("sprites/player/star_player.gif")

PLAYER_DAMAGED_SPRITE = file_path("sprites/player/star_player_damaged.gif")

KEYS_PATH = file_path("keys.txt")

PROFILES_PATH = file_path("color_profiles.txt")

LEVEL_PATH = file_path("levels/level_{level}.txt")