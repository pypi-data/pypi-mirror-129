...
'''a LIBrary implementing TGMK (Tebi-Gibi-Mebi-Kibi), a human-readable lossless case-insensitive 1024-base integer representation, suitable for bits and bytes
