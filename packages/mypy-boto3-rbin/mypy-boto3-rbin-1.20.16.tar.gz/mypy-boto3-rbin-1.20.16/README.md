...
[boto3.RecycleBin 1.20.16](https://boto3.amazonaws.com/v1/documentation/api/1.20.16/reference/services/rbin.html#RecycleBin)
...
- Install `boto-stubs[rbin]` in your environment:
  `python -m pip install 'boto3-stubs[rbin]'`
