...
class RecycleBinClient(BaseClient):
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.20.16/reference/services/rbin.html#RecycleBin.Client)
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.20.16/reference/services/rbin.html#RecycleBin.Client.can_paginate)
    ...
    def create_rule(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.20.16/reference/services/rbin.html#RecycleBin.Client.create_rule)
    ...
    def delete_rule(self, *, Identifier: str) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.20.16/reference/services/rbin.html#RecycleBin.Client.delete_rule)
    ...
    def generate_presigned_url(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.20.16/reference/services/rbin.html#RecycleBin.Client.generate_presigned_url)
    ...
    def get_rule(self, *, Identifier: str) -> GetRuleResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.20.16/reference/services/rbin.html#RecycleBin.Client.get_rule)
    ...
    def list_rules(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.20.16/reference/services/rbin.html#RecycleBin.Client.list_rules)
    ...
    def list_tags_for_resource(self, *, ResourceArn: str) -> ListTagsForResourceResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.20.16/reference/services/rbin.html#RecycleBin.Client.list_tags_for_resource)
    ...
    def tag_resource(self, *, ResourceArn: str, Tags: Sequence["TagTypeDef"]) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.20.16/reference/services/rbin.html#RecycleBin.Client.tag_resource)
    ...
    def untag_resource(self, *, ResourceArn: str, TagKeys: Sequence[str]) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.20.16/reference/services/rbin.html#RecycleBin.Client.untag_resource)
    ...
    def update_rule(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.20.16/reference/services/rbin.html#RecycleBin.Client.update_rule)
    ...
    def get_paginator(self, operation_name: Literal["list_rules"]) -> ListRulesPaginator:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.20.16/reference/services/rbin.html#RecycleBin.Paginator.ListRules)
