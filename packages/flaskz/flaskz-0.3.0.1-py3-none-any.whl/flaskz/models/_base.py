...
class BaseModelMixin:
    ...
    # def del_attrs(self, with_relationship=True):
    #     """
    #     Delete all attributes of the instance
    #     todo not null auto
    #     :param ins:
    #     :param with_relationship:
    #     :return:
    #     """
    #     cls = self.__class__
    #     pk_col = cls.get_primary_column()
    #     for col in cls.get_columns():
    #         if col is not pk_col:
    #             field = cls.get_column_field(col)  # col.key
    #             delattr(self, field)
    #     if with_relationship is not True:
