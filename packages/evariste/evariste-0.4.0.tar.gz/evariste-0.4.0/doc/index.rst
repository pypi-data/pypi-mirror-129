...
.. note::
  ...
  As of june 2018, although this project is far less active than I would like (and not documented yet),
...
See the `main project page <http://framagit.org/spalax/evariste>`_ for
instructions, and `changelog
<https://framagit.org/spalax/evariste/blob/main/CHANGELOG.md>`_.
