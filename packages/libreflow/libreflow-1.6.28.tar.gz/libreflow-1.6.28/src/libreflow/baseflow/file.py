...
class UploadAfterPublishValue(flow.values.BoolValue):
...
class PublishFileAction(LaunchSessionWorker):
    ...
    upload_after_publish = flow.BoolParam(False, UploadAfterPublishValue)
...
class PublishFileFromWorkingCopy(PublishFileAction):
    ...
    def run(self, button):
        ...
        publish_action.comment.set(self.comment.get())
        publish_action.keep_editing.set(self.keep_editing.get())
        publish_action.upload_after_publish.set(self.upload_after_publish.get())
        
        return publish_action.run('Publish')
