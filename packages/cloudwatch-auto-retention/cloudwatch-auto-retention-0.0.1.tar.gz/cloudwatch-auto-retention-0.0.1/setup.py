    ...
    """
{
    ...
    "version": "0.0.1",
    "description": "CloudWatch Auto Retention is a construct that creates a Lambda with a cronjob that checks if CloudWatch Logs are set to never-expire and if so, sets it to one month.",
    "license": "Apache-2.0",
    ...
    "package_data": {
        "cdk_cloudwatch_auto_retention._jsii": [
            "cloudwatch-auto-retention@0.0.1.jsii.tgz"
        ],
        "cdk_cloudwatch_auto_retention": [
            "py.typed"
        ]
