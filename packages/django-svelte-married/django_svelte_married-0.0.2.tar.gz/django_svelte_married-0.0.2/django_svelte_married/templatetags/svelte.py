...
from django_svelte_married.settings import (SVELTE_RELOADING_ENABLED, SVELTE_RELOADING_PORT, SVELTE_RENDERER)
...
# def svelte(context: Dict[str, any], component: str, props: any = None):
# if 'SVELTE_COMPONENTS' not in context:
#     context['SVELTE_COMPONENTS'] = {}

# context['SVELTE_COMPONENTS'][mount_id] = {'component': component, 'props': props_jsons}
# return mark_safe(f"id=\"{mount_id}\"")
...
def svelte_print(context: Dict[str, any]):
    return {'SVELTE_PRINT': mark_safe(json.dumps(context.get('SVELTE_COMPONENTS', {}))),
            'SVELTE_LIVERELOAD_ENABLED': SVELTE_RELOADING_ENABLED,
            'SVELTE_LIVERELOAD_PORT': SVELTE_RELOADING_PORT}
