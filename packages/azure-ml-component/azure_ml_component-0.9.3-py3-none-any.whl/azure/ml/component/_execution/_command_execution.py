...
def is_linux_container():
    ...
    error_msg = 'Cannot get os type from docker info. ' \
                'Please make sure docker installed and docker daemon is running. Detail message: %s.' % process_stdout
    try:
        docker_info = json.loads(process_stdout)
