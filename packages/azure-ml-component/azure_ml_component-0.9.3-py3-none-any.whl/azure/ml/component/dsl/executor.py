...
.. code-block:: bash
    ...
    [--function {your_function_name}] --params --{your_param_key} {your_param_value} ...

--file, -f: The dsl component file path.

--function: The dsl component function name. Optional if there is only one dsl component in the file.
...
class _ExecutorParser(argparse.ArgumentParser):
    ...
    def __init__(self):
        ...
        self.add_argument(
            "--function",
            help="The dsl component function name. Optional "
...
if __name__ == '__main__':
    ...
    ComponentExecutor.collect_component_from_file(
        executor_args.file, func_name=executor_args.function,
