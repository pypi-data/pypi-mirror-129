...
class OnlineStepRunDebugger(DebugRunner, WorkspaceTelemetryMixin):
    ...
    @track(_get_telemetry_logger, activity_name="OnlineStepRunDebugger_local_debug", activity_type=_PUBLIC_API)
    ...
    @track(_get_telemetry_logger, activity_name="OnlineStepRunDebugger_remote_debug", activity_type=_PUBLIC_API)
