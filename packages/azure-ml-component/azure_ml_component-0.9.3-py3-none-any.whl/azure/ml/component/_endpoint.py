...
from ._util._utils import int_str_to_pipeline_status, resolve_datasets_from_parameter, \
    resolve_data_path_assignments_from_parameter, ensure_valid_experiment_name
...
class PipelineEndpoint(WorkspaceTelemetryMixin):
    ...
    def submit(self, experiment_name: str = None, description: str = None, pipeline_parameters: dict = None) -> Run:
        ...
        pipeline_parameters, dataset_def_value_assignments = resolve_datasets_from_parameter(self.workspace,
                                                                                             pipeline_parameters)
        pipeline_parameters, data_path_assignments = resolve_data_path_assignments_from_parameter(pipeline_parameters)
