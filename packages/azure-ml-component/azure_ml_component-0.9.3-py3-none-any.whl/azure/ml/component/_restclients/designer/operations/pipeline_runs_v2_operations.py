...
class PipelineRunsV2Operations(object):
    ...
    def get_pipeline_run_graph_no_status(
            self, subscription_id, resource_group_name, workspace_name, pipeline_run_id, include_run_setting_params=True, has_namespace_concept=True, skip_dataset_load=False, referenced_node_id=None, custom_headers=None, raw=False, **operation_config):
        """
