...
class CosThetaGeometryTest(unittest.TestCase):
    ...
    def test_build_geometry_with_roxie_bare_absolute_angles_rectangle_csv(self, mock_show=None):
        ...
        block_df_path = create_resources_file_path('%sbare_absolute_block_data_rectangle.csv' % root_dir)
        layer_df_path = create_resources_file_path('%slayer_data.csv' % root_dir)
        cadata_path = create_resources_file_path('%sroxieold_2.cadata' % root_dir)
        cadata = CableDatabase.read_cadata(cadata_path)
    ...
    def test_build_geometry_with_roxie_bare_relative_angles_rectangle_csv(self, mock_show=None):
        # arrange
        root_dir = 'resources/geometry/roxie/16T/'
        block_df_path = create_resources_file_path('%sbare_relative_block_data_rectangle.csv' % root_dir)
        layer_df_path = create_resources_file_path('%slayer_data.csv' % root_dir)
        cadata_path = create_resources_file_path('%sroxieold_2.cadata' % root_dir)
        cadata = CableDatabase.read_cadata(cadata_path)
