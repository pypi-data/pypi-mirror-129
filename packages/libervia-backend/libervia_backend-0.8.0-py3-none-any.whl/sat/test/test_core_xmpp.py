...
class SatMessageProtocolTest(unittest.TestCase):
    ...
    def test_onMessage(self):
        ...
        """
        stanza = parseXml(xml)
        self.host.bridge.expectCall("messageNew", "sender@example.net/house", "test", "chat", "test@example.org/SàT", {}, profile=Const.PROFILE[0])
...
class SatRosterProtocolTest(unittest.TestCase):
    ...
    def test__registerItem(self):
        ...
        self.host.bridge.expectCall("newContact", Const.JID_STR[0], {'to': 'True', 'from': 'True', 'ask': 'False', 'name': 'Test Man'}, set(["Test Group 1", "Test Group 2", "Test Group 3"]), Const.PROFILE[0])
