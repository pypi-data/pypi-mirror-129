...
class Client(ProjectApi):
    ...
    def update_dataset_version_property(
        self, dataset_id: int, dataset_version_id: int, property_id: int, dataset_version: JsonObject
    ):
        """
        Create data version properties
        ...
        :return:
        """
        return DatasetVersionApi(dataset_id=dataset_id, **self._config).update_dataset_version_property(
            dataset_version_id, property_id, dataset_version
        )
    ...
    def get_attachment(self, artifact_type: str, artifact_version: int, file_id: int):
        ...
        """
        return AttachmentApi(self._config["_token"]).get_attachment(artifact_type, artifact_version, file_id)
    ...
    def update_attachments(
        ...
        :return: The json structure
        """
        return AttachmentApi(self._config["_token"]).update_attachment(artifact_type, artifact_version, files)
    ...
    def delete_attachment(self, artifact_type: str, artifact_version: int, file_id: int):
        ...
        :return: The json structure
        """
        return AttachmentApi(self._config["_token"]).delete_attachment(artifact_type, artifact_version, file_id)
    ...
    def list_attachments(self, artifact_type: str, artifact_version: int) -> PagedResponse[AttachmentOutput]:
        ...
        :return: The json structure
        """
        return AttachmentApi(self._config["_token"]).list_attachments(artifact_type, artifact_version)
