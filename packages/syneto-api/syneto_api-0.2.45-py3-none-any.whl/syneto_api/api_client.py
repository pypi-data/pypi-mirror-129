...
from tenacity import Retrying, AsyncRetrying, RetryError, stop_after_delay
...
class APIClientBase:
    ...
    async def _async_request(
        ...
        try:
            ...
            async for attempt in AsyncRetrying(stop=stop_after_delay(self.timeout), reraise=True):
                with attempt:
    ...
    def _sync_request(
        ...
        try:
            ...
            for attempt in Retrying(stop=stop_after_delay(self.timeout), reraise=True):
                with attempt:
