...
class CredentialsHelper:
    ...
    def set_azure_credentials(request, url_path):
        ...
        if account_name is None:
            raise Exception(
                "Azure account name must be defined for registering and obtaining data stored in Azure Blob storage!"
            )
        if account_key is None and sas_token is None:
            raise Exception(
                "Either Azure SAS token or Azure account key must be specified for registering and"
                " obtaining data stored in Azure Blob storage!"
            )
        if account_key and sas_token:
            raise Exception(
                "Specifying both Azure account key and Azure SAS token is not supported for registering and"
                " obtaining data stored in Azure Blob storage!"
            )
    ...
    def get_aws_access_token():
        ...
        if access_key is None:
            raise Exception(
                "AWS access key must be defined for registering features and obtaining data stored in S3!"
            )
        return access_key
    ...
    def get_aws_secret_token():
        ...
        if secret_key is None:
            raise Exception(
                "AWS secret key must be defined for registering features and obtaining data stored in S3!"
            )
        return secret_key
    ...
    def get_aws_region():
        ...
        if region is None:
            raise Exception(
                "AWS region must be defined for registering features and obtaining data stored in S3!"
            )
        return region
    ...
    def get_snowflake_user():
        ...
        if user is None:
            raise Exception(
                "Snowflake user name must be defined for registering features and obtaining data stored in Snowflake storage!"
            )
        return user
    ...
    def get_snowflake_password():
        ...
        if password is None:
            raise Exception(
                "Snowflake password must be defined for registering features and obtaining data stored in Snowflake storage!"
            )
        return password
    ...
    def get_jdbc_postgres_user():
        ...
        if password is None:
            raise Exception(
                "Username for accessing Postgres database must be defined for registering features from it!"
            )
        return password
    ...
    def get_jdbc_postgres_password():
        ...
        if password is None:
            raise Exception(
                "Password for accessing Postgres database must be defined for registering features from it!"
            )
        return password
    ...
    def get_jdbc_teradata_user():
        ...
        if password is None:
            raise Exception(
                "Username for accessing Teradata database must be defined for registering features from it!"
            )
        return password
