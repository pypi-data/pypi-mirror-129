...
class FeatureSet:
    ...
    @property
    def owner(self):
        return User(self._feature_set, self._feature_set.owner)
    ...
    @property
    def author(self):
        return User(self._feature_set, self._feature_set.author)
    ...
    def marked_for_removal(self):
        return self._feature_set.marked_for_removal
    ...
    def delete(self, wait_for_completion=True):
        ...
        exists_request.project_name = self._feature_set.project
        exists_request.feature_set_name = self._feature_set.feature_set_name
...
class User:
    def __init__(self, feature_set, user):
        self._feature_set = feature_set
        self._user = user
