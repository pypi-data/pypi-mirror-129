...
class RetrieveHolder(RetrieveAsLinksCommon):
    def __init__(self, stub, feature_set, start_date_time, end_date_time):
        self._stub = stub
    ...
    def preview(self, num_rows=10):
        ...
        resp = self._stub.GetPreview(request)
        print(resp.result)
    ...
    def as_spark_frame(self, spark_session):
        ...
        if self._feature_set.time_travel_column:
            return (
                df.withColumn(
                    timestamp_col,
                    unix_timestamp(
            ...
            return (
                ...
                .drop("time_travel_column_auto_generated")
            )

    def _create_retrieve_request(self):
