...
class CalibrateOD:
    def __init__(self, device):
        ...
        self.buttons4 = HBox([self.probe_group_selector, self.prev_batch_button, self.measure_signals_button,
                              self.next_batch_button, self.fit_curve_button, self.plot_curve_button])
    ...
    def set_stirrer1_speed(self, slider):
        self.device.stirrers.set_speed(1, self.stirrer1_slider.value)
