...
class process_text:
    ...
    def clear_generic_entity(self, text):
        ...
        entitites = [ent.text for ent in document.ents if ent.label_ == 'PERSON' or ent.label_ == 'ORDINAL' or ent.label_ == 'CARDINAL' or ent.label_ == 'PRODUCT' or ent.label_ == 'DATE']
    ...
    # def clear_generic_entities(self, text):
    #     document = self.nlp(text)
    #     items = [ent.text for ent in document.ents if ent.label_ == 'PERSON' or ent.label_ == 'ORDINAL' or ent.label_ == 'DATE']
