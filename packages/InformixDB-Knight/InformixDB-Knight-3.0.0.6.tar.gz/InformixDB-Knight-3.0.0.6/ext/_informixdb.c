 ...
 *   EXEC SQL BEGIN DECLARE SECTION;
 */
#line 3452 "_informixdb.ec"
#line 3453 "_informixdb.ec"
int exc_count;
  char message[255];
int messlen;
  char sqlstate[6];
