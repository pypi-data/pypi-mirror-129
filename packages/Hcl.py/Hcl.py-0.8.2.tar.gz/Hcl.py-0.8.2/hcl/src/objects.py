...
class FromCode:
    ...
    def FromCode(self):
        ...
        except (KeyError, TypeError): self.comId = self.json["extensions"]["community"]["ndcId"]
...
class Event:
    def __init__(self, data):
        ...
        try: self.payload: Payload = Payload(data["payload"]).Payload
        except (KeyError): self.payload: Payload = Payload({})
