...
class SelectUuid(object):
    ...
    def __int__(self,pyspark_python):
        pass
    ...
    def select_uuid_from_arrvied_data(
        ...
        df_categories = _spark.sql(f"""select c_id,c_name from {poi_categories_table}""").toPandas()
        ...
        df_arrive_levae = _spark.read.option("header", "true").parquet(temp_result + result_name)
