...
class AnyscaleSDK(DefaultApi):  # type: ignore
    def __init__(
        ...
        self.log: _CliLogger = _CliLogger()
    ...
    def build_cluster_environment(
        ...
        if not cluster_environments:
            self.log.info(f"Creating new cluster environment {create_cluster_environment.name}")
            ...
            self.log.info(f"Building new revision of cluster environment {create_cluster_environment.name}")
    ...
    def wait_for_cluster_environment_build_operation(
        ...
        self.log.info(f"Waiting for cluster environment to build. View progress at {url}.")
