...
def test_list_builds(
    ...
    cluster_env_controller = ClusterEnvController(
        base_mock_api_client, base_mock_anyscale_api_client, Mock()
    )
    ...
    with patch.multiple(
        ...
        cluster_env_controller._list_builds("mock_cluster_env_name", None, max_items=50)
        ...
        cluster_env_controller._list_builds(None, "mock_cluster_env_id", max_items=50)
        mock_list_builds.assert_called_with(
            "mock_cluster_env_id",
            cluster_env_controller.anyscale_api_client,
            max_items=50,
...
def test_list_cluster_envs(
    ...
    with patch.multiple(
        ...
        cluster_env_controller._list_cluster_envs(include_shared, max_items=50)
