...
@click.group("cluster", hidden=True, help="interact with clusters")
def cluster_cli() -> None:
    pass


@cluster_cli.command(
    name="start", help="Start or update and restart a cluster on Anyscale.", hidden=True
)
@click.option(
    "--name",
    required=False,
...
@click.option(
    ...
    default=None,
    help=(
        "Override id used for this cluster. If not provided, the Anyscale project "
...
@cluster_cli.command(
    name="terminate", help="Terminate a cluster on Anyscale.", hidden=True
)
@click.option(
    "--name",
    required=False,
...
def terminate(
    name: Optional[str], cluster_id: Optional[str], project_id: Optional[str],
) -> None:
    cluster_controller = ClusterController()
    cluster_controller.terminate(
        cluster_name=name, cluster_id=cluster_id, project_id=project_id,
    )
