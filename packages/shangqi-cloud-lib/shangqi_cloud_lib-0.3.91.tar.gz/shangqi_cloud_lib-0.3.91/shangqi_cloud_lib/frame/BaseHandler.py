...
class BaseHandler(tornado.web.RequestHandler, ABC):
    ...
    def set_current_user(self, username):
        logging.info("cookie_domain是{}".format(config.cookie_domain))
        self.set_cookie(name=config.app_scene, value=username,domain=config.cookie_domain)

    def get_current_user(self) -> Any:
        username = self.get_cookie(config.app_scene)
