...
class MycroftSkill:
    ...
    def __init__(self, name=None, bus=None, use_settings=True, skill_id=""):
        ...
        # New style skills can be fully initialized at once
        # most existing skills however do not pass the required kwargs
        # the advantage of this is that it makes __init__ method safer
        # for skill developers as long as they call super() before their code
        if bus and skill_id:
