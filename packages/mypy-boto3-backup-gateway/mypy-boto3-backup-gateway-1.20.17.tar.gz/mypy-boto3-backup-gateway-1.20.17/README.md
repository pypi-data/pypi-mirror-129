...
[boto3.BackupGateway 1.20.17](https://boto3.amazonaws.com/v1/documentation/api/1.20.17/reference/services/backup-gateway.html#BackupGateway)
...
- Install `boto-stubs[backup-gateway]` in your environment:
  `python -m pip install 'boto3-stubs[backup-gateway]'`
