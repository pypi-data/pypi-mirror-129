...
---------------------
It is a core module of MAICA to configure framework environments.
This module contains environment variables to define prediction task, machine learning algorithm,
and other algorithmic descriptors.
"""


# Data Formats
DATA_FORMAT_VEC = 'vec'         # Numerical Vector
DATA_FORMAT_IMG = 'img'         # Image Data
DATA_FORMAT_GRAPH = 'graph'     # Mathematical Graph
...
IMPUTE_KNN = 'knn'              # Fill empty value by k-nearest neighbor data_old.
...
ALGS_PYTORCH = [ALG_FCNN, ALG_ATE, ALG_DOPNET, ALG_GCN, ALG_GAT, ALG_GIN, ALG_CGCNN]
