...
class NotebookHandler {
    constructor(nbTracker) {
        this.scenesChanged = new _lumino_signaling__WEBPACK_IMPORTED_MODULE_2__.Signal(this);
        /* ****************************************************************************************************************************************
        ...
        notebookPanel.content.widgets.map((cell) => {
            if (!!cell.model.metadata.get(tag)) {
                if (cell.model.type == 'code') {
                    _jupyterlab_cells__WEBPACK_IMPORTED_MODULE_0__.CodeCell.execute(cell, notebookPanel.sessionContext, { recordTiming: notebookPanel.content.notebookConfig.recordTiming });
                }
            }
        });
    }
    ...
    // **** various **************************************************************
    updateCellClasses(notebook, scene_name) {
    ...
    jumpToNextSceneCell() {
        ...
        if (!presentCell)
            return;
        let cellIdx = (_a = this._nbTracker.currentWidget) === null || _a === void 0 ? void 0 : _a.content.widgets.indexOf(presentCell);
        let numCells = (_b = this._nbTracker.currentWidget) === null || _b === void 0 ? void 0 : _b.content.widgets.length;
        console.log('cellIdx', cellIdx);
        for (let n = cellIdx; n < numCells; n++) {
        }
    }
...
class NotebookSceneDatabase {
    ...
    getNotebookTitle() {
        ...
        return _jupyterlab_coreutils__WEBPACK_IMPORTED_MODULE_1__.PathExt.basename(this._nbTracker.currentWidget.context.localPath);
    }
    getScenesList() {
...
class ScenesDisplay extends react__WEBPACK_IMPORTED_MODULE_0__.Component {
    render() {
        return (react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: "scenes-ScenesSidebar" },
            react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: "scenes-Header" }, this.props.nbTitle),
    ...
    render() {
        let list = this.props.scenes.map(scene_name => {
            ...
            const onClickDelete = (event) => {
                ...
                this.props.commands.execute(_widget__WEBPACK_IMPORTED_MODULE_2__.ScenesSidebar.command_id_delete_scene, { 'scene_name': scene_name });
            };
            const onClickEdit = (event) => {
                event.preventDefault();
                event.stopPropagation();
                this.props.commands.execute(_widget__WEBPACK_IMPORTED_MODULE_2__.ScenesSidebar.command_id_rename_scene, { 'scene_name': scene_name });
            };
            ...
            return (react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: className, onClick: onClickActivate, key: scene_name },
                react__WEBPACK_IMPORTED_MODULE_0__.createElement("button", { className: "scenes-IconButton", title: "Delete Scene", onClick: onClickDelete },
                ...
                react__WEBPACK_IMPORTED_MODULE_0__.createElement("button", { className: "scenes-IconButton", title: "Run Scene", onClick: onClickRun },
                ...
                react__WEBPACK_IMPORTED_MODULE_0__.createElement("button", { className: "scenes-IconButton", title: "Rename Scene", onClick: onClickEdit },
...
class Toolbar extends react__WEBPACK_IMPORTED_MODULE_0__.Component {
    render() {
        const onClickNew = () => {
            this.props.commands.execute(_widget__WEBPACK_IMPORTED_MODULE_2__.ScenesSidebar.command_id_new_empty_scene);
        };
        const onClickDuplicate = () => {
            this.props.commands.execute(_widget__WEBPACK_IMPORTED_MODULE_2__.ScenesSidebar.command_id_duplicate_scene);
        };
        const onClickUp = () => {
            this.props.commands.execute(_widget__WEBPACK_IMPORTED_MODULE_2__.ScenesSidebar.command_id_move_active_scene_up);
        };
        const onClickDown = () => {
            this.props.commands.execute(_widget__WEBPACK_IMPORTED_MODULE_2__.ScenesSidebar.command_id_move_active_scene_down);
        };
        const onClickNext = () => {
            this.props.commands.execute(_widget__WEBPACK_IMPORTED_MODULE_2__.ScenesSidebar.command_id_to_next_scene_cell);
        };
        const onClickPrev = () => {
            this.props.commands.execute(_widget__WEBPACK_IMPORTED_MODULE_2__.ScenesSidebar.command_id_to_previous_scene_cell);
        };
        return (react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: "scenes-Toolbar" },
            react__WEBPACK_IMPORTED_MODULE_0__.createElement("button", { className: "scenes-IconButton", title: "New Empty Scene", onClick: onClickNew },
            ...
            react__WEBPACK_IMPORTED_MODULE_0__.createElement("button", { className: "scenes-IconButton", title: "Duplicate Active Scene", onClick: onClickDuplicate },
            ...
            react__WEBPACK_IMPORTED_MODULE_0__.createElement("button", { className: "scenes-IconButton", title: "Move Active Scene Up", onClick: onClickUp },
                react__WEBPACK_IMPORTED_MODULE_0__.createElement(_jupyterlab_ui_components__WEBPACK_IMPORTED_MODULE_1__.caretUpIcon.react, { tag: "span", className: "jp-ToolbarButtonComponent-icon f1vya9e0" })),
            react__WEBPACK_IMPORTED_MODULE_0__.createElement("button", { className: "scenes-IconButton", title: "Move Active Scene Down", onClick: onClickDown },
                react__WEBPACK_IMPORTED_MODULE_0__.createElement(_jupyterlab_ui_components__WEBPACK_IMPORTED_MODULE_1__.caretDownIcon.react, { tag: "span", className: "jp-ToolbarButtonComponent-icon f1vya9e0" })),
            react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: "scenes-SceneItemSpacer" }),
            react__WEBPACK_IMPORTED_MODULE_0__.createElement("button", { className: "scenes-IconButton align-right", title: "Jump to Next Scene Cell", onClick: onClickNext },
                react__WEBPACK_IMPORTED_MODULE_0__.createElement(_jupyterlab_ui_components__WEBPACK_IMPORTED_MODULE_1__.caretDownIcon.react, { tag: "span", className: "jp-ToolbarButtonComponent-icon f1vya9e0" })),
            react__WEBPACK_IMPORTED_MODULE_0__.createElement("button", { className: "scenes-IconButton align-right", title: "Move to Previous Scene Cell", onClick: onClickPrev },
                react__WEBPACK_IMPORTED_MODULE_0__.createElement(_jupyterlab_ui_components__WEBPACK_IMPORTED_MODULE_1__.caretUpIcon.react, { tag: "span", className: "jp-ToolbarButtonComponent-icon f1vya9e0" }))));
    }
}
...
/* harmony import */ var _components__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components */ "./lib/components.js");
/* harmony import */ var _backend__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./backend */ "./lib/backend.js");
...
class ScenesSidebar extends _jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_1__.ReactWidget {
    constructor(app, nbTracker, mainMenu) {
        ...
        this._notebookHandler = new _backend__WEBPACK_IMPORTED_MODULE_3__.NotebookHandler(nbTracker);
        this._setupWidget();
    ...
    render() {
        ...
        return (react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_components__WEBPACK_IMPORTED_MODULE_4__.ScenesDisplay, { nbTitle: nb_title, scenes: this._notebookHandler.getScenesList(), currentScene: this._notebookHandler.getActiveScene(), initScene: this._notebookHandler.getInitScene(), commands: this._app.commands, notebookHandler: this._notebookHandler }));
    }
    onNotebookChanged() {
        this.update();
    }
...
//# sourceMappingURL=lib_index_js.759046ad1f9be6dd88b1.js.map