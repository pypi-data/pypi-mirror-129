    ...
    render() {
        let list = this.props.scenes.map(scene_name => {
            ...
            const onClickDelete = (event) => {
                ...
                this.props.commands.execute(_widget__WEBPACK_IMPORTED_MODULE_4__.ScenesSidebar.command_id_delete_scene, { 'scene_name': scene_name });
            };
            const onClickEdit = (event) => {
                event.preventDefault();
                event.stopPropagation();
                this.props.commands.execute(_widget__WEBPACK_IMPORTED_MODULE_4__.ScenesSidebar.command_id_rename_scene, { 'scene_name': scene_name });
            };
...
class Toolbar extends react__WEBPACK_IMPORTED_MODULE_0__.Component {
    render() {
        const onClickNew = () => {
            this.props.commands.execute(_widget__WEBPACK_IMPORTED_MODULE_4__.ScenesSidebar.command_id_new_empty_scene);
        };
        const onClickDuplicate = () => {
            this.props.commands.execute(_widget__WEBPACK_IMPORTED_MODULE_4__.ScenesSidebar.command_id_duplicate_scene);
        };
        const onClickUp = () => {
            this.props.commands.execute(_widget__WEBPACK_IMPORTED_MODULE_4__.ScenesSidebar.command_id_move_active_scene_up);
        };
        const onClickDown = () => {
            this.props.commands.execute(_widget__WEBPACK_IMPORTED_MODULE_4__.ScenesSidebar.command_id_move_active_scene_down);
        };
        const onClickNext = () => {
            this.props.commands.execute(_widget__WEBPACK_IMPORTED_MODULE_4__.ScenesSidebar.command_id_to_next_scene_cell);
        };
        const onClickPrev = () => {
            this.props.commands.execute(_widget__WEBPACK_IMPORTED_MODULE_4__.ScenesSidebar.command_id_to_previous_scene_cell);
        };
...
//# sourceMappingURL=lib_index_js.9c45ebbafed746209bec.js.map