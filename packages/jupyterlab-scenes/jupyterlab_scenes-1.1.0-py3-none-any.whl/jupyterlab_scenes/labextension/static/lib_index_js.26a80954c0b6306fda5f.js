...
class ScenesSidebar extends _jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_1__.ReactWidget {
    constructor(app, nbTracker, mainMenu) {
        ...
        // this is needed for initialization on notebook loading, but it would be nicer to have a clean signal for that
        this._nbTracker.widgetAdded.connect((sender, nbpanel) => {
            var _a;
            (_a = nbpanel.content.model) === null || _a === void 0 ? void 0 : _a.metadata.changed.connect((_x) => {
                var _a;
                if ((_a = nbpanel.content.model) === null || _a === void 0 ? void 0 : _a.metadata.has('scenes_data')) {
...
//# sourceMappingURL=lib_index_js.26a80954c0b6306fda5f.js.map