...
class ScenesSidebar extends _jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_1__.ReactWidget {
    constructor(app, nbTracker, mainMenu) {
        ...
        this._nbTracker.widgetAdded.connect((sender, nbpanel) => {
            ...
            nbpanel.content.fullyRendered.connect((notebook, args) => {
                console.log('fully rendered');
                this.update();
                this._notebookHandler.updateCellClasses(notebook, this._notebookHandler.getActiveScene(notebook));
            });
        });
...
//# sourceMappingURL=lib_index_js.bd2b7a29c606dfaeb805.js.map