...
class TestBinaryOperatorLessThanEqualsExpression(TestCase):
    def setUp(self):
    ...
    def test_le_get_contained_variables(self):
        self.assertSetEqual(
            {"mock one", "mock two"},
