...
def hocr_page_to_word_data_fast(hocr_page):
    ...
    * `'confidence'`: word confidence, 0 - 100
    ...
    # TODO: pdftotree likes to put entire columns into a table, we want to
    # change that or treat a tr as a paragraph or something, otherwise text that
    # spans multiple columns ends up in the same paragraph, which will certainly
    # go wrong in various ways, probably want to look at the pdftotree code here
    for par in hocr_page.xpath('.//*[@class="ocr_par" or @class="ocrx_block"]'):
        # TODO: if we encounter td or tr, how do we deal with that? is every tr
        # a paragraph? Yuck

    # TODO: Support ocrx_block, ocr_table, 
    #for par in hocr_page.xpath('.//*[@class="ocrx_block"]'):
        paragraph_data = {'lines': []}
