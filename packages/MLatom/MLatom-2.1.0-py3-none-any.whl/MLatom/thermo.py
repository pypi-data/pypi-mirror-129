...
def thermocalc(mol, linear, sn, mult):
    ...
    print('\n Zero-point vibrational energy: %.5f kcal/mol' % ZPE)
...
def hofcalc(hofmethod, energy, ZPE, H298, numbers):
    ...
    elif hofmethod == 'aiqm1dft' or 'aiqm1dftstart':
    ...
    print(' Atomization enthalpy             at      0 K: %12.5f kcal/mol' % D0)
    print(' ZPE exclusive atomization energy at      0 K: %12.5f kcal/mol' % (D0 + ZPE))
    print(' Heat of formation                at 298.15 K: %12.5f kcal/mol' % deltaH298)
    print('\n')

def get_gau_thermo(imol):
    au2kcal = 627.5094738898777
