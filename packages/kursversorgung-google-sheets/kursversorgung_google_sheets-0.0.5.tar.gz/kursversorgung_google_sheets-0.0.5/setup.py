...
setup(
    ...
    package_data={'package': ['software_update.ico']},
    install_requires=['exchangelib', 'setuptools', 'gspread', 'pandas', 'oauth2client',
                      'google-api-python-client', 'bs4', 'beautifulsoup4', 'blpapi', 'xbbg', 'future'],
