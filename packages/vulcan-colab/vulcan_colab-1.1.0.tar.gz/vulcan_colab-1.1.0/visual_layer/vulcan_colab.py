...
def visual_layer():
  ...
  display(ipywidgets.Image(value=open("/content/0.png", "rb").read(),format='png')) # Header
  ...
  with tab.output_to(0, select=False): #):  
    ...
    with grid0.output_to(0,0):
      display(ipywidgets.Image(value=open("/content/2.png", "rb").read(),format='png', layout=l_vbox))
  ...
  with tab.output_to(1):#, select=False):
    ...
    with grid1.output_to(0,0):    
      display(ipywidgets.Image(value=open("/content/3.png", "rb").read(),format='png', layout=l_vbox))
  ...
  with tab.output_to(2, select=False):  
    ...
    with grid2.output_to(0,0):    
      display(ipywidgets.Image(value=open("/content/4.png", "rb").read(),format='png', layout=l_vbox))
  ...
  with tab.output_to(3, select=False):  
    ...
    with grid3.output_to(0,0):    
      display(ipywidgets.Image(value=open("/content/5.png", "rb").read(),format='png', layout=l_vbox))
  ...
  with tab.output_to(4, select=False):  
    ...
    with grid4.output_to(0,0):    
      display(ipywidgets.Image(value=open("/content/6.png", "rb").read(),format='png', layout=l_vbox))
  ...
  with tab.output_to(5, select=False):
    ...
    with grid5.output_to(0,0):    
      display(ipywidgets.Image(value=open("/content/7.png", "rb").read(),format='png', layout=l_vbox))
  ...
  with tab.output_to(6, select=False):  
    ...
    with grid6.output_to(0,0):    
      display(ipywidgets.Image(value=open("/content/8.png", "rb").read(),format='png', layout=l_vbox))
  ...
  with tab.output_to(7, select=False):  
    ...
    with grid7.output_to(0,0):    
      display(ipywidgets.Image(value=open("/content/9.png", "rb").read(),format='png', layout=l_vbox))
