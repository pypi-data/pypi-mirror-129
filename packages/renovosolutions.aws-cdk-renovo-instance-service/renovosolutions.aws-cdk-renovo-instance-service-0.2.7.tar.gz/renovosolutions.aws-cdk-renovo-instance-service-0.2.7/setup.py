    ...
    """
{
    ...
    "package_data": {
        "renovo-instance-service._jsii": [
            "cdk-library-renovo-instance-service@0.2.7.jsii.tgz"
        ],
        "renovo-instance-service": [
            "py.typed"
        ]
    ...
    "install_requires": [
        ...
        "jsii>=1.46.0, <2.0.0",
        "publication>=0.0.3",
        "renovosolutions.aws-cdk-aspects-security-group>=0.2.5, <0.3.0",
        "renovosolutions.aws-cdk-managed-instance-role>=0.1.5, <0.2.0"
    ],
    "classifiers": [
