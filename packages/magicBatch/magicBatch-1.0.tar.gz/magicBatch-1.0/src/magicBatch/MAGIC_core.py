...
#from magic.MAGIC_core import compute_markov


def magicBatch(data=None, mar_mat_input=None, n_pca_components=20, n_diffusion_components = 0, random_pca=True,t=None, 
          k=30, ka=10, epsilon=1, rescale_percent = 90, rescale_method = 'adaptive', csv_l=None, csv_d=None, csv_i=None, to_print=None):
    if(to_print != None):
        print(to_print)
