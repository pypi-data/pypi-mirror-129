...
async def get(app: web.Application, url: Union[URL, str], obj: Union[str, HEAObjectType, Type[HEAObjectType]], headers: Optional[Dict[str, str]] = None) -> Optional[HEAObjectType]:    # type: ignore[return]
    """
...
async def get_all(app: web.Application, url: Union[URL, str], obj: Type[HEAObjectType], headers: Optional[Dict[str, str]] = None):    # type: ignore[return]
    """
