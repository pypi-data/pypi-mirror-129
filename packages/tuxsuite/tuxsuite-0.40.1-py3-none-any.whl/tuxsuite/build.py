...
# We will poll for status change for an average duration of 240 minutes
state_timeout = 14400  # 60 * 240
    ...
    def watch(self, iterator=False):
        ...
        while True:
            ...
            if state != previous_state:
                ...
                raise tuxsuite.exceptions.Timeout(
                    f"Test timed out after {state_timeout/60} minutes; abandoning"
                )
            elif iterator:
                yield
