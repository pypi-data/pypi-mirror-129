...
class StateFileLocator(abc.ABC):
 location="_none_"
 active_instance=NjdlE
 @abc.abstractmethod
 def get_state_file_location_by_key(self,key:Njdlb)->Njdlb:
  pass
 @Njdlf
 def get(cls,requested_file_locator:Njdlb):
...
class ObjectStorageProvider(abc.ABC):
 ...
 active_instance=NjdlE
 @Njdlf
 def get(cls,state_file_locator:Njdlb,requested_storage:Njdlb,serializers:Dict[Njdlb,CPVCSSerializer]):
  ...
  return cls.active_instance
 def __init__(self,state_file_locator:StateFileLocator,serializers:Dict[Njdlb,CPVCSSerializer]):
 ...
 def get_state_file_location_by_key(self,key:Njdlb)->Njdlb:
  pass
 @abc.abstractmethod
 def get_version_by_key(self,key:Njdlb)->Version:
  pass
 @abc.abstractmethod
 def get_revision_by_key(self,key:Njdlb)->Revision:
  pass
 @abc.abstractmethod
 def get_revision_or_version_by_key(self,key:Njdlb)->Union[Revision,Version]:
  pass
 @abc.abstractmethod
 def get_delta_file_by_key(self,key:Njdlb)->Njdlb:
  pass
 @abc.abstractmethod
 def upsert_objects(self,*args:CPVCSObj)->List[Njdlb]:
  pass
 @abc.abstractmethod
 def update_revision_key(self,old_key:Njdlb,new_key:Njdlb,referenced_by_version:Njdlb=NjdlE):
  pass
 @abc.abstractmethod
 def version_exists(self,key:Njdlb)->Njdlk:
  pass
 @abc.abstractmethod
 def merge_remote_into_local_version(self,remote_location:Njdlb,key:Njdlb):
  pass
 @abc.abstractmethod
 def _update_key(self,old_key:Njdlb,new_key:Njdlb,base_path:Njdlb)->Njdlk:
  pass
 @abc.abstractmethod
 def _serialize(self,*args:CPVCSObj)->List[Njdlb]:
  pass
 @abc.abstractmethod
 def _deserialize(self,key_serializer:Dict[Njdlb,Njdlb],remote_location:Njdlb=NjdlE)->List[CPVCSObj]:
  pass
class ObjectStorageLocal(ObjectStorageProvider):
 ...
 def _serialize(self,*args:CPVCSObj)->List[Njdlb]:
  ...
  for cpvcs_obj in args:
   if NjdlT(cpvcs_obj,Version):
    hash_refs.append(self.serializers["version"].store_obj(cpvcs_obj))
   elif NjdlT(cpvcs_obj,Revision):
    hash_refs.append(self.serializers["revision"].store_obj(cpvcs_obj))
  return hash_refs
 def _deserialize(self,key_serializer:Dict[Njdlb,Njdlb],remote_location:Njdlb=NjdlE)->List[Union[Revision,Version]]:
