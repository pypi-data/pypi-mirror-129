...
class StateFileLocator(abc.ABC):
 location="_none_"
 active_instance=UIRzN
 @abc.abstractmethod
 def get_state_file_location_by_key(self,key:UIRzY)->UIRzY:
  pass
 @UIRzC
 def get(cls,requested_file_locator:UIRzY):
...
class ObjectStorageProvider(abc.ABC):
 ...
 active_instance=UIRzN
 @UIRzC
 def get(cls,state_file_locator:UIRzY,requested_storage:UIRzY,serializers:Dict[UIRzY,CPVCSSerializer]):
  ...
  return cls.active_instance
 def __init__(self,state_file_locator:StateFileLocator,serializers:Dict[UIRzY,CPVCSSerializer]):
 ...
 def get_state_file_location_by_key(self,key:UIRzY)->UIRzY:
  pass
 @abc.abstractmethod
 def get_version_by_key(self,key:UIRzY)->Version:
  pass
 @abc.abstractmethod
 def get_revision_by_key(self,key:UIRzY)->Revision:
  pass
 @abc.abstractmethod
 def get_revision_or_version_by_key(self,key:UIRzY)->Union[Revision,Version]:
  pass
 @abc.abstractmethod
 def get_delta_file_by_key(self,key:UIRzY)->UIRzY:
  pass
 @abc.abstractmethod
 def upsert_objects(self,*args:CPVCSObj)->List[UIRzY]:
  pass
 @abc.abstractmethod
 def update_revision_key(self,old_key:UIRzY,new_key:UIRzY,referenced_by_version:UIRzY=UIRzN):
  pass
 @abc.abstractmethod
 def version_exists(self,key:UIRzY)->UIRzD:
  pass
 @abc.abstractmethod
 def merge_remote_into_local_version(self,remote_location:UIRzY,key:UIRzY):
  pass
 @abc.abstractmethod
 def _update_key(self,old_key:UIRzY,new_key:UIRzY,base_path:UIRzY)->UIRzD:
  pass
 @abc.abstractmethod
 def _serialize(self,*args:CPVCSObj)->List[UIRzY]:
  pass
 @abc.abstractmethod
 def _deserialize(self,key_serializer:Dict[UIRzY,UIRzY],remote_location:UIRzY=UIRzN)->List[CPVCSObj]:
  pass
class ObjectStorageLocal(ObjectStorageProvider):
 ...
 def _serialize(self,*args:CPVCSObj)->List[UIRzY]:
  ...
  for cpvcs_obj in args:
   if UIRzv(cpvcs_obj,Version):
    hash_refs.append(self.serializers["version"].store_obj(cpvcs_obj))
   elif UIRzv(cpvcs_obj,Revision):
    hash_refs.append(self.serializers["revision"].store_obj(cpvcs_obj))
  return hash_refs
 def _deserialize(self,key_serializer:Dict[UIRzY,UIRzY],remote_location:UIRzY=UIRzN)->List[Union[Revision,Version]]:
