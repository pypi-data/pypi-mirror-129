...
class FfmpegProcess:
    ...
    def run(self, progress_handler=None, ffmpeg_output_file=None):
        ...
        input_file_info = FileInfoProvider(filepath)
        duration_microseconds = input_file_info.get_duration() * 1_000_000
        ...
        progress_bar.clear()
        previous_microseconds_processed = 0
        ...
        try:
            while self._process.poll() is None:
                ...
                if "out_time_ms" in line:
                    microseconds_processed = int(line.strip()[12:])
                    microseconds_increase = microseconds_processed - previous_microseconds_processed
                    progress_bar.update(microseconds_increase)
                    previous_microseconds_processed = microseconds_processed
