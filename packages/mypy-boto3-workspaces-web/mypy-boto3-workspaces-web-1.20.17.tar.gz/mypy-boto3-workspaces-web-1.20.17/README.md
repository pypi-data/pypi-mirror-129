...
[boto3.WorkSpacesWeb 1.20.17](https://boto3.amazonaws.com/v1/documentation/api/1.20.17/reference/services/workspaces-web.html#WorkSpacesWeb)
...
- Install `boto-stubs[workspaces-web]` in your environment:
  `python -m pip install 'boto3-stubs[workspaces-web]'`
