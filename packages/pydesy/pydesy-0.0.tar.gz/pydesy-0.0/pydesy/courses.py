...
class TheodoliteCourse: 
    ...
    def setDirectionAngles(self, startDirectionAngle, endDirectionAngle):
        self.startDirectionAngle = startDirectionAngle
        self.endDirectionAngle = endDirectionAngle

    def setHorizontalAngles(self, horizontalAngles):
        self.horizontalAngles = horizontalAngles
        
    def setSideLenghts(self, sideLenghts):
        self.sideLenghts = sideLenghts
        
    def setAverageExcess(self, averageExcess):
    ...
    def drawCource(self):
        ...
        plt.plot([self.startPoint.y] + [point.y for point in self.points] +  [self.endPoint.y], [self.startPoint.x] + [point.x for point in self.points] + [self.endPoint.x], marker="o")
        plt.xlabel("y")
        plt.ylabel("x")
