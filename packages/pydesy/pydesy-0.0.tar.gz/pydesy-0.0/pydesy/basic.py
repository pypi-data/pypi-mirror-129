...
class Point:
    ...
    def dirGeoProblem(self, d=0, a=0):
        return dirGeoProblem(self.x, self.y, d, a)
    
    def invertGeoProblem(self, x, y):
        return invertGeoProblem(self.x, self.y, x, y)
...
def dirGeoProblem(x=0, y=0, d=0, a=0):
    return {"x" : x + d * cos(a), "y" : y + d * sin(a)}


#Invert geodetic problem
def invertGeoProblem(x1=0,y1=0,x2=0,y2=0):
    dx, dy = x2 - x1, y2 - y1
