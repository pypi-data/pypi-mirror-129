    ...
    def _update_device_listener(
        ...
        for listener in self.device_listeners:
            try:
                ...
                LOGGER.exception("on_device_update event occur error")
                ...
                for device_id in removed_device_id_list:
                    ...
                    for listener in self.outer.device_listeners:
                        try:
                            ...
                            LOGGER.exception("on_device_removed event occur error")
                ...
                for device_id in added_device_id_list:
                    ...
                    for listener in self.outer.device_listeners:
                        try:
                            ...
                            LOGGER.exception("on_device_added event occur error")
