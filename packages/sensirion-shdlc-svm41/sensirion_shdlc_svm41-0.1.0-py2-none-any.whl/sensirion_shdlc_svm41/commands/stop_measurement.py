...
class Svm41CmdStopMeasurementBase(ShdlcCommand):
    """
    ...
    def __init__(self, *args, **kwargs):
        ...
        Constructor.
        """
        super(Svm41CmdStopMeasurementBase, self).__init__(
            0x01, *args, **kwargs)


class Svm41CmdStopMeasurement(Svm41CmdStopMeasurementBase):
    """
    ...
    def __init__(self):
        ...
        Constructor.
        """
        super(Svm41CmdStopMeasurement, self).__init__(
            data=[],
