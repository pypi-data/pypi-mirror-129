...
class Svm41CmdFirmwareUpdateBase(ShdlcCommand):
    """
    ...
    def __init__(self, *args, **kwargs):
        ...
        Constructor.
        """
        super(Svm41CmdFirmwareUpdateBase, self).__init__(
            0xF3, *args, **kwargs)


class Svm41CmdEnterBootloader(Svm41CmdFirmwareUpdateBase):
    """
    ...
    def __init__(self):
        ...
        Constructor.
        """
        super(Svm41CmdEnterBootloader, self).__init__(
            data=[],
...
class Svm41CmdStartUpdate(Svm41CmdFirmwareUpdateBase):
    """
    ...
    def __init__(self):
        ...
        Constructor.
        """
        super(Svm41CmdStartUpdate, self).__init__(
...
class Svm41CmdUpdateData(Svm41CmdFirmwareUpdateBase):
    """
    Update Data Command
    ...
    def __init__(self, data):
        ...
        """
        super(Svm41CmdUpdateData, self).__init__(
...
class Svm41CmdStopUpdate(Svm41CmdFirmwareUpdateBase):
    """
    Stop Update Command
    ...
    def __init__(self, checksum):
        ...
        """
        super(Svm41CmdStopUpdate, self).__init__(
