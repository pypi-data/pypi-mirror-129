...
class Svm41CmdGetVersionBase(ShdlcCommand):
    """
    ...
    def __init__(self, *args, **kwargs):
        ...
        Constructor.
        """
        super(Svm41CmdGetVersionBase, self).__init__(
            0xD1, *args, **kwargs)


class Svm41CmdGetVersion(Svm41CmdGetVersionBase):
    """
    Get Version Command
    ...
    def __init__(self):
        ...
        Constructor.
        """
        super(Svm41CmdGetVersion, self).__init__(
            data=[],
