    ...
    def get_text_triple(self, prop_name):
        ...
        for i in range(0, length):
            ...
            for index, sent in target_sents.items():
                ...
                RE = Relation_extraciton(prop_name, filter_data, sub_order, sub_id, object_list, self.C_path,
                                         abbre_pairs)
