...
var metannoRenderer = /*#__PURE__*/function (_Widget) {
  ...
  function metannoRenderer(options, manager) {
    ...
    _defineProperty(_assertThisInitialized(_this), "mimeType", void 0);
  ...
  _createClass(metannoRenderer, [{
    ...
    value: function () {
      var _showContent = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
        var source, editor_id, editor_type, manager;
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 2:
                source = this.model.data[this.mimeType];
                editor_id = source['editor-id'];
                editor_type = source['editor-type']; // Let's be optimistic, and hope the widget state will come later.
