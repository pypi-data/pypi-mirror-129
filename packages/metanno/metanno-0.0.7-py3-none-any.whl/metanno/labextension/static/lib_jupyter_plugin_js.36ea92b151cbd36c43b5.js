...
(function (CodeCell) {
  ...
  function _execute() {
    _execute = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(cell, sessionContext, metadata) {
      var _sessionContext$sessi, _cell$outputArea, _cell$outputArea$widg, _cell$outputArea$widg2, _cell$outputArea$widg3;

      var model, code, cellId, _metadata, recordTiming, future, msgPromise, recordTimingHook, msg, timingInfo, started, finished;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 5:
              ...
              if (!(cell !== null && cell !== void 0 && (_cell$outputArea = cell.outputArea) !== null && _cell$outputArea !== void 0 && (_cell$outputArea$widg = _cell$outputArea.widgets) !== null && _cell$outputArea$widg !== void 0 && (_cell$outputArea$widg2 = _cell$outputArea$widg[0]) !== null && _cell$outputArea$widg2 !== void 0 && (_cell$outputArea$widg3 = _cell$outputArea$widg2.widgets) !== null && _cell$outputArea$widg3 !== void 0 && _cell$outputArea$widg3[1].editor_type)) {
...
//# sourceMappingURL=lib_jupyter_plugin_js.36ea92b151cbd36c43b5.js.map