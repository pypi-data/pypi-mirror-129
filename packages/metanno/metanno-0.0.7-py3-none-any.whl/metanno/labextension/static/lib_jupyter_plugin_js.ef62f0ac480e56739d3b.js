...
var MetannoArea = /*#__PURE__*/function (_Panel) {
  ...
  function MetannoArea(options) {
    ...
    if (!_this._editor_id || !_this._editor_type) {
      var widget = _this._cell.outputArea.widgets[0];
  ...
  _createClass(MetannoArea, [{
    ...
    get: function get() {
      ...
      return this === null || this === void 0 ? void 0 : (_this$_notebook = this._notebook) === null || _this$_notebook === void 0 ? void 0 : (_this$_notebook$conte = _this$_notebook.context) === null || _this$_notebook$conte === void 0 ? void 0 : _this$_notebook$conte.path;
    }
  }]);
...
function activateMetannoExtension(app, rendermime, docManager, tracker, settingRegistry, menu, loggerRegistry, restorer //palette: ICommandPalette,
) {
  var commands = app.commands,
      shell = app.shell,
      contextMenu = app.contextMenu;
  var notebookTracker = new _notebook.NotebookTracker({
    namespace: 'notebook'
  });
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 13:
                ...
                void metannoAreas.add(widget); // Remove the output view if the parent notebook is closed.
  ...
  _createClass(MetannoRenderer, [{
    ...
    get: function get() {
      if (!this._editor_type) {
        var source = this.model.data[this._mimeType];
        this._editor_type = source['editor-id'];
      }
...
//# sourceMappingURL=lib_jupyter_plugin_js.ef62f0ac480e56739d3b.js.map