...
project = u'Libervia PubSub'
copyright = u'2021, Jérôme Poisson'
...
latex_documents = [
    (master_doc, 'STPubSub.tex', u'Libervia PubSub Documentation',
...
man_pages = [
    (master_doc, 'stpubsub', u'Libervia PubSub Documentation',
     [author], 1)
]
