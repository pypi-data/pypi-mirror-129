...
class Service:
    ...
    def get_list(self, parameter: Dict = None, **kwargs) -> QueryResult:
        """
        Get data list
    ...
    def get_first(self, parameter: Dict = None, **kwargs) -> dict:
        """
    ...
    def get_count(self, parameter: Dict = None) -> CountResult:
        """
