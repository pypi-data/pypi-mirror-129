...
[boto3.IoTTwinMaker 1.20.17](https://boto3.amazonaws.com/v1/documentation/api/1.20.17/reference/services/iottwinmaker.html#IoTTwinMaker)
...
- Install `boto-stubs[iottwinmaker]` in your environment:
  `python -m pip install 'boto3-stubs[iottwinmaker]'`
