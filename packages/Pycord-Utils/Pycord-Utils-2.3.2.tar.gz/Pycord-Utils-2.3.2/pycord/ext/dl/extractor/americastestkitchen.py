...
class AmericasTestKitchenIE(InfoExtractor):
    ...
    def _real_extract(self, url):
        ...
        return {
            ...
            "url": "https://player.zype.com/embed/%s.js?api_key=jZ9GUhRmxcPvX7M3SlfejB6Hle9jyHTdk2jVxG7wOHPLODgncEKVdPYBhuz9iWXQ"
            % video["zypeId"],
            "ie_key": "Zype",
    ...
    def _real_extract(self, url):
        ...
        season_search = self._download_json(
            ...
            query={
                ...
                "attributesToRetrieve": "description,search_%s_episode_number,search_document_date,search_url,title"
                % slug,
            ...
            for episode in season_search.get("hits") or []:
                ...
                yield {
                    ...
                    "episode_number": int_or_none(
                        episode.get("search_%s_episode_number" % slug)
                    ),
                    "ie_key": AmericasTestKitchenIE.ie_key(),
                }

        return self.playlist_result(entries(), "season_%d" % season_number, season)
