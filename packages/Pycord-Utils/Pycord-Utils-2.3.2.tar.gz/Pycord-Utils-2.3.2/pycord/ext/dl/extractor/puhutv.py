...
class PuhuTVIE(InfoExtractor):
    ...
    def _real_extract(self, url):
        ...
        info = self._download_json(
            urljoin(url, "/api/slug/%s-izle" % display_id), display_id
        )["data"]
...
class PuhuTVSerieIE(InfoExtractor):
    ...
    def _real_extract(self, url):
        ...
        info = self._download_json(
            urljoin(url, "/api/slug/%s-detay" % playlist_id), playlist_id
        )["data"]
        ...
        return self.url_result(
            "https://puhutv.com/%s-izle" % video_id, PuhuTVIE.ie_key(), video_id
        )
