...
class MioMioIE(InfoExtractor):
    ...
    _TESTS = [
        ...
        },
        {
            ...
            "info_dict": {"id": "173113", "title": "The New Macbook 2015 上手试玩与简评"},
            "playlist_mincount": 2,
            "skip": "Unable to load videos",
        },
        {
    ...
    def _extract_mioplayer(self, webpage, video_id, title, http_headers):
        xml_config = self._search_regex(
            r'flashvars="type=(?:sina|video)&amp;(.+?)&amp;', webpage, "xml config"
        )
        ...
        vid_config_request = sanitized_Request(
            "http://www.miomio.tv/mioplayer/mioplayerconfigfiles/sina.php?{0}".format(
                xml_config
            ),
