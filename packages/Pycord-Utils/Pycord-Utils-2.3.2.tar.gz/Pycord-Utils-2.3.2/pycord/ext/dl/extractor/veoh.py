...
class VeohIE(InfoExtractor):
    ...
    def _extract_video(self, source):
        return {
            ...
            "age_limit": 18
            if source.get("isMature") == "true" or source.get("isSexy") == "true"
            else 0,
    ...
    def _real_extract(self, url):
        ...
        video = self._download_json(
            "https://www.veoh.com/watch/getVideo/" + video_id, video_id
        )["video"]
        title = video["title"]
        ...
        return {
            ...
            "duration": int_or_none(video.get("lengthBySec"))
            or parse_duration(video.get("length")),
