...
class SafariBaseIE(InfoExtractor):
    ...
    def _login(self):
        ...
        _, urlh = self._download_webpage_handle(
            auth.get("redirect_uri") or next_uri,
            None,
            "Completing login",
        )
    ...
    def _real_extract(self, url):
        ...
        if self.LOGGED_IN:
            kaltura_session = self._download_json(
                "%s/player/kaltura_session/?reference_id=%s"
                % (self._API_BASE, reference_id),
                video_id,
...
class SafariApiIE(SafariBaseIE):
    ...
    def _real_extract(self, url):
        ...
        part = self._download_json(
            url,
            "%s/%s" % (mobj.group("course_id"), mobj.group("part")),
...
class SafariCourseIE(SafariBaseIE):
    ...
    def _real_extract(self, url):
        ...
        course_json = self._download_json(
            ...
            % (self._API_BASE, course_id, self._API_FORMAT),
            course_id,
