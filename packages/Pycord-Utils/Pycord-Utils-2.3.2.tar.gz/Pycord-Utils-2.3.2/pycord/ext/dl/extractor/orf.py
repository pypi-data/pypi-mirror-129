...
class ORFRadioIE(InfoExtractor):
    def _real_extract(self, url):
        ...
        data = self._download_json(
            ...
            % (self._API_STATION, show_id, show_date),
            show_id,
        )
            ...
            entries.append(
                {
                    ...
                    "url": "https://loopstream01.apa.at/?channel=%s&id=%s"
                    % (self._LOOP_STATION, loop_stream_id),
                    "title": title,
...
class ORFFM4IE(ORFRadioIE):
    ...
    IE_DESC = "radio FM4"
    _VALID_URL = (
        r"https?://(?P<station>fm4)\.orf\.at/player/(?P<date>[0-9]+)/(?P<show>4\w+)"
    )
    _API_STATION = "fm4"
    _LOOP_STATION = "fm4"
...
class ORFNOEIE(ORFRadioIE):
    ...
    _VALID_URL = (
        r"https?://(?P<station>noe)\.orf\.at/player/(?P<date>[0-9]+)/(?P<show>\w+)"
    )
    _API_STATION = "noe"
    _LOOP_STATION = "oe2n"
...
class ORFWIEIE(ORFRadioIE):
    ...
    IE_DESC = "Radio Wien"
    _VALID_URL = (
        r"https?://(?P<station>wien)\.orf\.at/player/(?P<date>[0-9]+)/(?P<show>\w+)"
    )
    _API_STATION = "wie"
    _LOOP_STATION = "oe2w"
...
class ORFOOEIE(ORFRadioIE):
    ...
    _VALID_URL = (
        r"https?://(?P<station>ooe)\.orf\.at/player/(?P<date>[0-9]+)/(?P<show>\w+)"
    )
    _API_STATION = "ooe"
    _LOOP_STATION = "oe2o"
...
class ORFKTNIE(ORFRadioIE):
    ...
    _VALID_URL = (
        r"https?://(?P<station>kaernten)\.orf\.at/player/(?P<date>[0-9]+)/(?P<show>\w+)"
    )
    _API_STATION = "ktn"
    _LOOP_STATION = "oe2k"
...
class ORFSBGIE(ORFRadioIE):
    ...
    _VALID_URL = (
        r"https?://(?P<station>salzburg)\.orf\.at/player/(?P<date>[0-9]+)/(?P<show>\w+)"
    )
    _API_STATION = "sbg"
    _LOOP_STATION = "oe2s"
...
class ORFTIRIE(ORFRadioIE):
    ...
    IE_DESC = "Radio Tirol"
    _VALID_URL = (
        r"https?://(?P<station>tirol)\.orf\.at/player/(?P<date>[0-9]+)/(?P<show>\w+)"
    )
    _API_STATION = "tir"
    _LOOP_STATION = "oe2t"
...
class ORFOE3IE(ORFRadioIE):
    ...
    _VALID_URL = (
        r"https?://(?P<station>oe3)\.orf\.at/player/(?P<date>[0-9]+)/(?P<show>\w+)"
    )
    _API_STATION = "oe3"
    _LOOP_STATION = "oe3"
...
class ORFOE1IE(ORFRadioIE):
    ...
    _VALID_URL = (
        r"https?://(?P<station>oe1)\.orf\.at/player/(?P<date>[0-9]+)/(?P<show>\w+)"
    )
    _API_STATION = "oe1"
    _LOOP_STATION = "oe1"
