...
class MindsIE(MindsBaseIE):
    ...
    def _real_extract(self, url):
        ...
        return {
            ...
            "uploader_url": "https://www.minds.com/" + uploader_id
            if uploader_id
            else None,
...
class MindsFeedBaseIE(MindsBaseIE):
    ...
    def _entries(self, feed_id):
        ...
        while True:
            data = self._call_api(
                "v2/feeds/container/%s/videos" % feed_id, feed_id, "page %s" % i, query
            )
    ...
    def _real_extract(self, url):
        ...
        feed = self._call_api(
            "v1/%s/%s" % (self._FEED_PATH, feed_id), feed_id, self._FEED_TYPE
        )[self._FEED_TYPE]
