    ...
    def _real_extract(self, url):
        ...
        if smuggled_data.get("force_title"):
            ...
            title = self._html_search_regex(
                r"<title>([^<]+)</title>", webpage, video_id
            )
        ...
        if video_type == "arch":
            ...
            formats = [
                {
                    ...
                    "url": compat_urlparse.urljoin(domain, filename)
                    + "?v=3.1.0&fp=&r=&g=",
                }
            ]
        else:
            ...
            for entry in self._extract_m3u8_formats(
                m3u8_url, video_id, ext="mp4", m3u8_id="m3u8"
            ):
