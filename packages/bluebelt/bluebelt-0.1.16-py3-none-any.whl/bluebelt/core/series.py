from bluebelt.data.resolution import GroupByDatetimeIndex, Resample
import pandas as pd
import numpy as np
...
import bluebelt.analysis.graph
...
class SeriesToolkit():
    ...
    class data():
        ...
        @bluebelt.core.decorators.add_docstring(bluebelt.data.resolution.Resample)
    ...
    class graph():
        ...
        @bluebelt.core.decorators.add_docstring(bluebelt.analysis.graph.line)
        def line(self, **kwargs):
            return bluebelt.analysis.graph.line(self._obj, **kwargs)

        @bluebelt.core.decorators.add_docstring(bluebelt.analysis.graph.scatter)
        def scatter(self, **kwargs):
            return bluebelt.analysis.graph.scatter(self._obj, **kwargs)

        @bluebelt.core.decorators.add_docstring(bluebelt.analysis.graph.area)
        def area(self, **kwargs):
            return bluebelt.analysis.graph.area(self._obj, **kwargs)

        @bluebelt.core.decorators.add_docstring(bluebelt.analysis.graph.hist)
        def hist(self, **kwargs):
            return bluebelt.analysis.graph.hist(self._obj, **kwargs)
            
        histogram = hist

        @bluebelt.core.decorators.add_docstring(bluebelt.analysis.graph.boxplot)
        def boxplot(self, **kwargs):
            return bluebelt.analysis.graph.boxplot(self._obj, **kwargs)
