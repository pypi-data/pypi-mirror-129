...
class _Proxy(object):
    ...
    def __setattr__(self, key, value):
        super(_Proxy, self).__setattr__(key, value)


class Proxy(_Proxy):
    def _proxy_bind(self, obj):
        super(Proxy, self).__setattr__("_proxy_obj", obj)

    def __getattr__(self, item):
        return getattr(self._proxy_obj, item)

    def __setattr__(self, key, value):
        setattr(self._proxy_obj, key, value)
