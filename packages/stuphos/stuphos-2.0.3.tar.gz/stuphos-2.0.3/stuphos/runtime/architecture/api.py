...
from stuphos.runtime.architecture import Procedure, Computer, Source
...
from stuphos.runtime.architecture import baseInstance
...
def getIsSuperuser():
	from phsite.network.embedded.wizard import is_superuser
	return is_superuser
