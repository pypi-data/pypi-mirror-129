...
class Client(Fist):
    ...
    def insert_algo_order(self, tg_name: str, exchange: ExchangeID, ticker: str, volume: float, order_type: OrderType, direction: Side, start_time: str, end_time: str, asset_type=AssetType.NOT_AVAILABLE, **algo_args):
        '''
        提交算法单请求
