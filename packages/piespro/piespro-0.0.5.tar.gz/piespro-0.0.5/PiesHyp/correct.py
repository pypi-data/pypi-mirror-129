...
def correct_hypnogram(df):
    new_df = deepcopy(df)
    new_df = fill_same_voids(new_df, time_threshold=60)
    new_df = fill_wakerem_voids(new_df, time_threshold=60)
    new_df = fill_nonrem_voids(new_df, time_threshold=60)
    new_df = fill_sleep_voids(new_df, time_threshold=60)
    new_df = correct_rem(new_df, time_threshold=5 * 60)
