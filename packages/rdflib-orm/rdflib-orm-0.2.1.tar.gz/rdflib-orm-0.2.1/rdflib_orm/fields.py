...
class IRIField(Field):
    ...
    def convert(self, value: Union[URIRef, 'Model', List[Union[URIRef, 'Model']]], **kwargs):
        ...
        if isinstance(value, str):
            ...
            # TODO: Improve error message.
            if not isinstance(value, list) and not isinstance(value, Model):
                raise FieldError(f'Expected a list or a Model. Instead got {isinstance(value)}')
