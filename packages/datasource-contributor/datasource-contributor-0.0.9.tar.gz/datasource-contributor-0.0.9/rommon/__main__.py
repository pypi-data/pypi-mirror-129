...
from rommon.ROM.spiders.nyc import NycSpider
from rommon.ROM.spiders.chicacgo import ChicacgoSpider
from rommon.ROM.spiders.rom import RomSpider
...
def handle_craw():
    ...
    print("爬虫名称： %s" % spiderName)
    domain = input("请输入爬取的domin: ")
    print("domin: %s" % domain)
    ...
    crawler.crawl(RomSpider)
    crawler.crawl(NycSpider)
    crawler.crawl(ChicacgoSpider)
