...
trade_period = ('2021-11-25','2021-11-29') #(last test date, yesterdays date)
today_date = '2021-11-30'
accountid = "DU1770002"
...
while current_time < end_time:
    ...
    agent.make_day_trade(actions,weights,accountid=accountid,symbol_type="futures",demo=True) #for live account demo is False
