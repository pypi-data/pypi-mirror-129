...
def get_baseline(ticker,sec_types,exchanges,start,end,mode,demo,symbol_type):
    if mode == 'daily':
...
def backtest_stats(df,baseline_start = config.START_TRADE_DATE,
    ...
    baseline_df = get_baseline(ticker=baseline_ticker,sec_types=sec_types,exchanges=exchanges,start=baseline_start,end=baseline_end,
                                mode=mode,demo=demo,symbol_type=symbol_type)
