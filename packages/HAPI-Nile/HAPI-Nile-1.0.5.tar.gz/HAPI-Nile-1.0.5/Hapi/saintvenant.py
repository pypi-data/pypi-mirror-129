                ...
                if XSarea[x] <= 0:
                    ...
                    if XSarea[x] <= Sub.AreaPerLow[x,0] :
                        ...
                        if XSarea[x] <= bankful_area:
                            ...
                            dummyh = QuadraticEqn(Sub.cr[x]/Sub.hr[x] + Sub.cl[x]/Sub.hl[x], 2*Sub.mw[x],-2*dummyarea)
                    ...
                    # if the new area is less than the area of the max[hl,hr]  
                        ...
                        if Sub.hl[x] < Sub.hr[x] :
                            # case 2
                            dummyh = QuadraticEqn(Sub.cr[x]/Sub.hr[x]*0.5, Sub.mw[x]+Sub.cl[x],-dummyarea-Sub.hl[x]*Sub.cl[x]*0.5)
                        else :
                            # case 3
                            dummyh = QuadraticEqn(Sub.cl[x]/Sub.hl[x]*0.5,Sub.mw[x]+Sub.cr[x],-dummyarea-Sub.hr[x]*Sub.cr[x]*0.5)
